package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1134:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_660:uint = 0;
      
      public static const const_670:String = "AssetLibraryReady";
      
      public static const const_1412:String = "AssetLibraryUnloaded";
      
      public static const const_393:String = "AssetLibraryLoaded";
      
      public static const const_1417:String = "AssetLibraryLoadError";
       
      
      private var var_543:XML;
      ...
      private var var_544:Boolean = true;
      
      private var var_380:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_778 = new Dictionary(false);
         var_145 = new Dictionary(false);
         var_1134.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_442)
         {
            _loc4_ = AssetTypeDeclaration(var_442[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_778)
         {
            delete var_778[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
         ...
         var_325 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1412));
      }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in var_145)
         {
            _loc3_ = var_145[_loc2_];
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_543 = _loc2_.manifest.copy();
         var_380 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_544)
         {
            AssetLibrary.fetchLibraryContents(this,var_543,var_380);
         }
         var_325 = true;
         dispatchEvent(new Event(AssetLibrary.const_393));
         dispatchEvent(new Event(AssetLibrary.const_670));
         if(var_544)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_443[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_947,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1048,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_442.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_442[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1134.splice(var_1134.indexOf(this),1);
            --var_660;
            var_443 = null;
            var_778 = null;
            var_145 = null;
      ...
      {
         return param1 < var_379.length ? getAssetByName(var_379[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_145)
         {
            if(var_145[_loc2_] == param1)
            {
               return var_379.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_442[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_778[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_543.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_380[param1]);
      ...
      {
         var _loc2_:IAsset = var_145[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_443[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++var_216;
                     var_379.push(struct.assetName);
                  }
                  var_145[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_40,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_145)
            {
               if(var_145[_loc2_] == param1)
               {
                  var_379.splice(var_379.indexOf(_loc2_),1);
                  delete var_145[_loc2_];
                  --var_216;
                  return param1;
               }
            }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_442[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_380 != null ? false : false;
      }
   }
}
