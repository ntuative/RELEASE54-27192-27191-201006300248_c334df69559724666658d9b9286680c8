package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_543:XML;
      
      protected var var_1025:LoaderContext;
      
      protected var var_32:Array;
      
      protected var var_585:Array;
      
      private var var_698:uint = 0;
      
      protected var var_479:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_32 = new Array();
         var_585 = new Array();
         var_1025 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_479 = new AssetLibrary("lib-" + var_698++);
         var_32.push(var_479);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_479.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_479.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_585.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_479.loadAssetFromFile(param1,param2,param3);
      }
      
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         return var_479.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_479.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_479.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_585.length)
            {
               _loc3_ = var_585[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_585.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_479.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_479.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
