package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_868:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1701:uint = 1;
      ...
      protected var var_1204:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_1031:String = "";
      
      protected var var_2426:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_449:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_195.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_1031 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1031);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1204 & const_868)
         {
            if(_loc3_ == 0)
            {
               if(var_195.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_195.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_449 + "]";
      }
