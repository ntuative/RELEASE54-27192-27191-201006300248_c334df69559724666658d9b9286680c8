   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1255);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         {
            if(var_263[_loc3_].url == param1.url)
            {
               return var_263[_loc3_].loadFromFile(param1);
            }
            _loc3_++;
         }
         var _loc4_:LibraryLoader = new LibraryLoader(param2,var_695);
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc8_:uint = var_195.mapStructsByImplementor(this,_loc7_);
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1288);
      }
      
      public final function detachComponent(param1:Component) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = var_195.getIndexByImplementor(param1);
         while(_loc3_ > -1)
         {
            _loc2_ = var_195.remove(_loc3_);
            _loc3_ = var_195.getIndexByImplementor(param1);
         }
         var _loc4_:int = 0;
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_667);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               error("Invalid component class " + componentString + "!",true,Core.const_667);
               return false;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_667);
                  }
               }
      ...
      {
         var _loc3_:InterfaceStruct = var_195.getStructByInterface(param1);
         if(_loc3_ != null)
         {
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            var_195.insert(new InterfaceStruct(_loc5_,param1));
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
