package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1175:String = "zip-libraries";
      
      private static const const_1178:String = "library";
      
      private static const const_1174:String = "library";
      
      private static const const_1173:String = "asset-libraries";
      
      private static const const_1172:String = "library";
      
      private static const const_1176:String = "service-libraries";
      
      private static const const_1177:String = "library";
      
      private static const const_1179:String = "component-libraries";
       
      
      private var var_808:IEventDispatcher;
      
      private var var_975:Profiler;
      
      private var var_296:uint;
      
      private var var_573:Array;
      
      private var var_297:LibraryLoaderQueue;
      
      private var var_673:Array;
      
      private var var_809:ProfilerViewer;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_695 = (param2 & 0) == Core.CORE_SETUP_DEBUG;
         var_573 = new Array();
         var_673 = new Array();
         var_225 = param1;
         var _loc3_:int = 0;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1326);
         if(!_isDisposed)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = var_573[_loc4_] as Array;
      ...
      {
         return var_252 - getNumberOfFilesPending();
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_808)
         {
            ...
            var_808.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
      ...
      private function debugFrameUpdateHandler(param1:Event) : void
      {
         ...
         var _loc3_:uint = _loc2_ - var_296;
         var_296 = _loc2_;
         _loc4_ = 0;
         while(_loc4_ < CoreComponent.const_139)
         {
            var_673[_loc4_] = 0;
            _loc5_ = var_573[_loc4_];
            _loc8_ = 0;
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         var_808 = loadingEventDelegate;
         if(var_297 == null)
         {
            var_297 = new LibraryLoaderQueue(var_695);
         }
         try
         {
            node = config.child(const_1175)[0];
            if(node != null)
            {
               list = node.child(const_1178);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new ZipLoader(context,true,var_695);
         ...
         try
         {
            node = config.child(const_1173)[0];
            if(node != null)
            {
               list = node.child(const_1172);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_695);
                  assets.loadFromFile(loader,true);
                  loader.load(new URLRequest(url));
                  var_297.push(loader);
                  loader.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,updateLoadingProcess);
         ...
         try
         {
            node = config.child(const_1176)[0];
            if(node != null)
            {
               list = node.child(const_1177);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_695);
         ...
         try
         {
            node = config.child(const_1179)[0];
            if(node != null)
            {
               list = node.child(const_1174);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_695);
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_573[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      private function profilerFrameUpdateHandler(param1:Event) : void
      {
         ...
         var msSinceLastUpdate:uint = msCurrentTime - var_296;
         var_296 = msCurrentTime;
         var_975.start();
         criticality = 0;
         while(criticality < CoreComponent.const_139)
         {
            var_673[criticality] = 0;
            receivers = var_573[criticality];
            index = 0;
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_975.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_139)
            {
               _loc2_ = var_573[_loc3_] as Array;
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_808)
         {
            var_808.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_139)
         {
            ...
            {
               if(var_673[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_808)
               {
                  var_808.dispatchEvent(new LibraryProgressEvent(_loc2_.url,var_252 - 0,var_252,_loc2_.elapsedTime));
               }
            }
         }
         if(false)
