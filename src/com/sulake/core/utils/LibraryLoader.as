package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      public static const const_967:int = 5;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_380 = this.getDefinition(_name) as Class;
         if(var_380 == null)
         {
         ...
         try
         {
            xmlClass = var_380.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_543 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_477 == LibraryLoader.const_1449)
         {
            if(analyzeLibrary())
            {
               var_477 |= 0;
         ...
         if(var_477 == LibraryLoader.name_2)
         {
            var_584 = true;
            var_194 = getTimer();
            prepareLibrary();
      ...
      {
         return !!var_584 ? uint(var_194 - var_835) : uint(getTimer() - var_835);
      }
