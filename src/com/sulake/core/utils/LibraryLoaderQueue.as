package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         _loc2_ = var_616.indexOf(param1);
         if(_loc2_ > -1)
         {
            var_616.splice(_loc2_,1);
         }
         _loc2_ = var_263.indexOf(param1);
         if(_loc2_ > -1)
         {
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(var_263.length < const_1453 && false)
            {
               _loc1_ = var_616.shift();
               var_263.push(_loc1_);
               _loc1_.resume();
            }
         }
