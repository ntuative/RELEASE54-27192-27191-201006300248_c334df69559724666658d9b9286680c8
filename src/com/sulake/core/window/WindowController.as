package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1272:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      private static var var_1532:Point = new Point();
      
      protected static const const_1062:String = "_COLORIZE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_409 = _loc13_.blend;
            var_588 = _loc13_.treshold;
            if(var_693 != _loc13_.background)
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_119,WindowParam.const_148);
         var _loc2_:* = !testParamFlag(WindowParam.const_120,WindowParam.const_146);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_283)
               {
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_861;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_693 = param1;
         var_589 = !!var_693 ? uint(var_589 | var_1488) : uint(var_589 & 16777215);
         var_171 = var_171 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_74);
      }
      
      public function set mouseTreshold(param1:uint) : void
      {
         var_588 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1843 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_310:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_663:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_597:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1058:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_601:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_451:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_420:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_497:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_264:
               _loc2_ = "null";
         }
      ...
      {
         var_409 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1055);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1059 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_345,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_588);
      }
      
      public function set color(param1:uint) : void
      {
         var_1488 = param1 & 4278190080;
         var_589 = !!var_693 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_74);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_672))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1047;
                  if(testParamFlag(WindowParam.const_308))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_269))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_269))
                  {
                     _context.getWindowServices().getMouseScalingService().end(this);
                  }
                  break;
               case MouseEvent.MOUSE_OUT:
                  if(testStateFlag(WindowState.const_78))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_156:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_497,this,null));
                     if(testParamFlag(WindowParam.const_173,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_146))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_12 != null)
                     {
                        ...
                        _param = _loc9_;
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_264,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_388:
                  _context.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_385);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1039,this,null));
                     if(var_12 != null)
                     {
               ...
               case WindowNotifyEvent.const_334:
                  if(param1 == this)
                  {
                     ...
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_208,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_451:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_985);
                  break;
               case WindowNotifyEvent.const_411:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1452) == -1)
                     {
                        _loc8_.style = var_83;
                     }
                  }
               ...
               case WindowNotifyEvent.const_420:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_385);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_208:
                  ...
                  break;
               case WindowNotifyEvent.const_497:
                  var_12.getRegionProperties(null,var_312);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_345:
      ...
      {
         return var_690 != null ? var_690 : (var_12 != null ? var_12.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_588);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_677,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_601;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1059 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_403)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_378)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_1060,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_565,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_156,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1360,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_63,true);
         _loc1_.type = WindowNotifyEvent.const_1363;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_171 && var_588 > 0)
         {
            if(!testParamFlag(WindowParam.const_30))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1532,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1532,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_63,false);
         _loc1_.type = WindowNotifyEvent.const_1375;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_12 != param1)
         {
            ...
            if(var_12 != null)
            {
               var_312 = var_12.rectangle.clone();
               var_58.x = var_11.x;
               var_58.y = var_11.y;
               var_58.width = var_11.width;
               var_58.height = var_11.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_444,this,var_12));
            }
            else
            {
               var_312.x = 0;
               ...
               var_312.width = 0;
               var_312.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1000,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_420,this,null));
         }
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = getParamFlag(WindowParam.const_62);
         for each(_loc1_ in _children)
         {
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               setParamFlag(WindowParam.const_62,false);
            }
            ...
            if(_loc8_)
            {
               setParamFlag(WindowParam.const_62,true);
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,_param,_context,var_11,null,var_690,properties,var_694.concat(),_id) as WindowController;
         _loc2_.var_588 = var_588;
         _loc2_.var_171 = var_171;
         _loc2_.var_695 = var_695;
         ...
         _loc2_.var_1488 = var_1488;
         _loc2_.var_1205 = var_1205;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_345;
         _loc2_.background = var_693;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_508;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_37 == WindowState.const_382)
         {
            return true;
         }
         var_37 = WindowState.const_382;
         ...
         _loc1_.type = WindowNotifyEvent.const_1037;
         update(this,_loc1_);
         dispose();
         return true;
      }
