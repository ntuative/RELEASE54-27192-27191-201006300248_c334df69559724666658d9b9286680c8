package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_774:String = "margin_top";
      
      private static const const_1081:String = "_SCALER";
      
      private static const const_775:String = "margin_right";
      
      private static const const_1082:String = "_HEADER";
      
      private static const const_1080:String = "_TITLE";
      
      private static const const_1083:String = "_CONTENT";
      
      private static const const_776:String = "margin_left";
      
      private static const const_777:String = "margin_bottom";
      ...
      private var var_1243:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_776,_loc3_.left,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_774,_loc3_.top,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_775,0 - _loc3_.right,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_777,0 - _loc3_.bottom,PropertyStruct.const_59,_loc2_));
         return _loc1_;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1062,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_269);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_229);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_198);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1243 == null)
         {
            var_1243 = findChildByTag(const_1082) as IHeaderWindow;
            if(!var_1243)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1080) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1081) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_265,false);
         }
      ...
      {
         return content != null && var_584 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1083) as IWindowContainer;
            if(!var_22)
            {
