package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1098:String = "_CONTROLS";
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1062,_loc2_,true);
      ...
      {
         return findChildByTag(const_1080) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(const_1098) as IItemListWindow;
      }
   }
}
