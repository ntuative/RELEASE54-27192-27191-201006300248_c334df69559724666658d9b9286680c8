package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_871:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_352)
         {
            ...
            if(var_352)
            {
               var_352.addEventListener(WindowEvent.const_271,scrollBarEventProc);
               var_352.addEventListener(WindowEvent.const_221,scrollBarEventProc);
            }
         }
         return var_352;
      }
      ...
      override public function dispose() : void
      {
         if(var_352)
         {
            var_352.removeEventListener(WindowEvent.const_271,scrollBarEventProc);
            var_352.removeEventListener(WindowEvent.const_221,scrollBarEventProc);
            var_352 = null;
         }
         if(var_871)
         {
      ...
      {
         if(param1.type == WindowEvent.const_271)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_221)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_871)
         {
            var_871 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_871;
      }
