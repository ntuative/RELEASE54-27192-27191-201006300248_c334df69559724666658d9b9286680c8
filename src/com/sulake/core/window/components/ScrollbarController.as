package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1086:String = "increment";
      
      private static const const_515:String = "slider_bar";
      
      private static const const_1085:String = "decrement";
      
      private static const const_782:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_171 = false;
         var_23 = param12;
         _horizontal = param2 == WindowType.const_374;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_444)
         {
            if(var_23 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(const_782) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_872 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_872 != null)
         {
            _loc1_ = findParentByName(var_872) as IScrollableWindow;
            if(_loc1_ == null && var_12 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_12).findChildByName(var_872) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_48)
         {
            ...
            else if(param2.name == const_1085)
            {
               if(var_23)
               {
                  var_605 = true;
         ...
         if(param1.type == WindowMouseEvent.const_835)
         {
