package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1479:String = "TAB_BUTTON_ICON";
      
      private static const const_1480:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1146:String = "TAB_BUTTON_TITLE";
      ...
      {
         if(param2.type == WindowNotifyEvent.const_264)
         {
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1146));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
