package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1026:ITabSelectorWindow;
      
      private var var_935:Boolean = false;
      
      protected var var_1724:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1724 == null)
         {
            var_1724 = findChildByTag(const_1116) as IWindowContainer;
         }
         return var_1724;
      }
      ...
      {
         return var_1026.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1026 == null)
         {
            var_1026 = findChildByTag(const_1115) as ITabSelectorWindow;
            if(var_1026 != null)
            {
               var_1026.procedure = selectorEventProc;
            }
         }
         return var_1026;
      }
      ...
      {
         return !!var_935 ? selector.iterator : null;
      }
