package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_586:String = "none";
      
      protected var var_691:Number;
      
      protected var var_394:Number;
      
      protected var _field:TextField;
      
      protected var var_837:Boolean = false;
      ...
      private static function method_11(param1:TextController, param2:uint) : void
      {
      ...
      {
         return new Rectangle(var_691 * maxScrollH,var_394 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_837)
         {
            context.removeLocalizationListener(var_345,this);
         }
         if(var_71 != null)
         {
            var_71.dispose();
      ...
      {
         var_691 = param1;
         _field.scrollH = var_691 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_345 = param1;
         if(var_345.charAt(0) == "$" && var_345.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_345.slice(2,var_345.indexOf("}")),this);
            var_837 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_224)
         {
            if(param2.type == WindowNotifyEvent.const_156)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_844,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_498,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_498,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_612,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_612,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_71.left,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_top",var_71.top,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_right",var_71.right,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_71.bottom,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("auto_size",var_586,PropertyStruct.STRING,var_586 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_612,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_586 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_586 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_586 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_586 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
