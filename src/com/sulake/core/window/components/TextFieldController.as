package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_935:Boolean = false;
      
      protected var var_1021:uint = 500;
      
      protected var var_1030:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_19)
         {
            var_19 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_979,var_11);
         }
         return var_19;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_1030,PropertyStruct.const_56,var_1030 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_935 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               var_1030 = _loc2_.value as Boolean;
               if(var_1030)
               {
