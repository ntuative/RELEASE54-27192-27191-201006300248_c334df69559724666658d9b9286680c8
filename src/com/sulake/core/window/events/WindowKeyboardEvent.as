package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_566:String = "WKE_KEY_UP";
       
      
      private var var_711:KeyboardEvent;
      ...
      {
         _type = param1;
         var_711 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get keyLocation() : uint
      {
         return var_711.keyLocation;
      }
      
      public function get shiftKey() : Boolean
      {
         return var_711.shiftKey;
      }
      
      public function get charCode() : uint
      {
         return var_711.charCode;
      }
      
      public function get keyCode() : uint
      {
         return var_711.keyCode;
      }
      
      public function get altKey() : Boolean
      {
         return var_711.altKey;
      }
      ...
      {
         return new WindowKeyboardEvent(_type,var_711,window,related,bubbles,cancelable);
      }
   }
}
