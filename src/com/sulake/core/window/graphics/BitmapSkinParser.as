package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_78:String = "hovering";
         ...
         if(param2.length() > 0)
         {
            ...
            else
            {
               ...
               while(_loc22_ < _loc20_)
               {
                  ...
                  {
                     method_10(param3,_loc23_,_loc11_,_loc7_);
                     _loc21_++;
                  }
                  _loc22_++;
               }
      ...
      protected static function method_10(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:* = null;
      ...
      protected static function parseRenderStateList(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            method_10(param1,_loc5_[_loc7_],param3,param4);
            _loc7_++;
         }
      }
