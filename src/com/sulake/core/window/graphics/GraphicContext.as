package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_864:uint = 256;
      
      protected static var var_698:uint = 0;
      
      protected static var var_400:uint = 0;
      
      public static const const_979:uint = 2;
      
      public static const const_1554:uint = 128;
      
      public static const const_1644:uint = 64;
      
      public static const const_735:uint = 4;
      
      public static const const_1408:uint = 0;
      
      public static const const_1389:uint = 16;
      
      public static const const_725:uint = 1;
      
      public static const const_1241:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_692:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_979:
               ...
               break;
            case GraphicContext.const_1241:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1389:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_735:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_864:
               break;
            case GraphicContext.const_1408:
               break;
            default:
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_172 = new Sprite();
            var_172.name = this.name + " - Child Container";
            var_172.mouseEnabled = false;
            addChild(var_172);
         }
         return var_172;
      }
