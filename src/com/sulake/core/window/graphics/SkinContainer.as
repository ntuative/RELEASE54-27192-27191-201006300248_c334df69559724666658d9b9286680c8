package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_771:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1769 = new Dictionary();
         TypeCodeTable.fillTables(var_1513,var_1769);
         var_1232 = new Dictionary();
         var_1768 = new Dictionary();
         StateCodeTable.fillTables(var_1232,var_1768);
         ...
         var_490["null"] = NullSkinRenderer;
         if(var_399 == null)
         {
            var_399 = new Array();
            var_399.push(WindowState.const_63);
            var_399.push(WindowState.const_65);
            var_399.push(WindowState.const_89);
            var_399.push(WindowState.WINDOW_STATE_SELECTED);
            var_399.push(WindowState.const_78);
            var_399.push(WindowState.const_75);
            var_399.push(WindowState.const_97);
            var_399.push(WindowState.const_83);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1232)
         {
            _loc3_.push(var_1232[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1513[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_709[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_709[param1] = new Array(SkinContainer.const_771);
         }
         var_709[param1][param2] = param3;
         if(true)
         {
            var_710[param1] = new Array(SkinContainer.const_771);
         }
