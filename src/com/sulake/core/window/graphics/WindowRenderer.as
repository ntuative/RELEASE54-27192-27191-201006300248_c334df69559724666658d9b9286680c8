package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1697:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_680 = new Array();
         var_1696 = new Point();
         var_1697 = new Rectangle();
         var_338 = new Rectangle();
         var_337 = new Dictionary(true);
         var_725 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_337[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_680.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_338.x = _loc3_.dirty.x;
               var_338.y = _loc3_.dirty.y;
               var_338.width = _loc3_.dirty.width;
               var_338.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_338);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_668,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_337[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_337[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_680 = null;
            for(_loc1_ in var_337)
            {
               delete var_337[_loc1_];
            }
            var_337 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1696,var_1697))
            {
               if(param2.render(param1,var_1696,var_1697))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_725);
            var_337[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_668,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_338.x = param2.x - param1.x;
            var_338.y = param2.y - param1.y;
            var_338.width = param2.width;
            var_338.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_30))
            {
               while(param1.testParamFlag(WindowParam.const_30))
               {
                  ...
                  var_338.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_338,WindowRedrawFlag.const_288);
            if(var_680.indexOf(param1) == -1)
            {
               var_680.push(param1);
            }
         }
