package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1664:String = "_INCLUDE";
      
      public static const const_907:String = "_EXCLUDE";
      
      public static const const_1633:String = "_TEMP";
      
      private static const const_1100:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1099:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1202:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_1023:Dictionary;
      
      protected var var_1485:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1486:Dictionary;
      
      protected var var_1203:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1203 = new Dictionary();
         var_1202 = new Dictionary();
         TypeCodeTable.fillTables(var_1203,var_1202);
         var_1023 = new Dictionary();
         var_1486 = new Dictionary();
         ParamCodeTable.fillTables(var_1023,var_1486);
         var_1485 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1099,"");
         return param1.replace(const_1100,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1203)
            {
               delete var_1203[_loc1_];
            }
            for(_loc1_ in var_1202)
            {
               delete var_1202[_loc1_];
            }
            for(_loc1_ in var_1023)
            {
               delete var_1023[_loc1_];
            }
            for(_loc1_ in var_1486)
            {
               delete var_1486[_loc1_];
            }
            var_1485.dispose();
            var_1485 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_907) == -1)
                  {
