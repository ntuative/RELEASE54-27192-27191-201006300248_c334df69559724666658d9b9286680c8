package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_2060:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         var_37 = name_1;
         _assets = param4;
         var_930 = String(param1);
         _revision = String(param2);
         var_1118 = param3 + var_930 + ".swf";
         var_1118 = var_1118.replace("%revision%",_revision);
         var _loc5_:AssetLibraryCollection = _assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(var_930 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + var_930);
            var_37 = name_2;
         }
      }
      ...
      {
         var_37 = var_2060;
         var _loc1_:URLRequest = new URLRequest(var_1118);
