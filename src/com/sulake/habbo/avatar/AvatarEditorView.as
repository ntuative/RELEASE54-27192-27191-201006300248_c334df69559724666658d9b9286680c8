package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_505:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_504:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1068 = [];
         var_1080 = [AvatarEditorFigureCategory.const_729,AvatarEditorFigureCategory.const_39,AvatarEditorFigureCategory.const_204,AvatarEditorFigureCategory.const_747,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_90];
         super();
         _controller = param1;
         ...
         var_357 = new Timer(1000);
         var_357.addEventListener(TimerEvent.TIMER,onUpdate);
         if(param4 == null)
         {
            param4 = var_1080;
         }
      ...
      public function update() : void
      {
         ...
         if(_controller.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1552 == AvatarEditorSideCategory.const_90 || var_1885))
         {
      ...
      public function dispose() : void
      {
         ...
         {
            var_357.stop();
            var_357.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_357 = null;
         }
         if(_window != null)
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_504)
         {
            ...
            var_504 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_504.procedure = stripClubDialogEventProc;
            var_504.center();
         }
         else
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_505 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_505.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1068.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_505.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_505.numSelectables)
               {
                  var_505.getSelectableAt(_loc6_).x = var_505.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1080);
         }
         if(param1.length != var_1068.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1068.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_697:
               break;
            case AvatarEditorSideCategory.const_470:
               _loc3_ = _controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_470);
               break;
            case AvatarEditorSideCategory.const_90:
               _loc3_ = _controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_90);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      {
         if(var_1552 == AvatarEditorSideCategory.const_90)
         {
            var_1885 = false;
            setSideContent(AvatarEditorSideCategory.const_697);
         }
         else
         {
            setSideContent(AvatarEditorSideCategory.const_90);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_285 = param1;
         var_505.setSelected(var_505.getSelectableByName(param1));
         _window.invalidate();
      }
