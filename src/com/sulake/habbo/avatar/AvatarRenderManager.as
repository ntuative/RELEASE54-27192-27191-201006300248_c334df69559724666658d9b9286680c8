package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_232:AvatarAssetDownloadManager;
      
      private var var_366:PetDataManager;
      
      private var var_421:Map;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_365:AssetAliasCollection;
      
      private var var_744:PaletteManager;
      ...
      private function method_7() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:AvatarStructure = var_135.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc1_ != null && var_232 == null)
         {
            ...
            var_232 = new AvatarAssetDownloadManager(var_30.assets,_loc2_,_loc3_,_loc1_);
            var_232.addEventListener(Event.COMPLETE,onAvatarAssetsDownloadManagerReady);
         }
      }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_135.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_135.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function onStructureInit(param1:Event = null) : void
      {
         ...
         if(_loc2_.avatarType == AvatarType.const_66)
         {
            method_7();
         }
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         var_232.loadFigureSetData(param1,param2);
      }
      ...
      private function init() : void
      {
         ...
         var_365 = new AssetAliasCollection(_loc1_);
         var_366 = new PetDataManager(_loc1_,this);
         var_744 = new PaletteManager(_loc1_);
         var _loc2_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_366.populateFigureData(_loc2_);
         _loc3_ = new AvatarStructure(this,assets,_loc1_,AvatarType.const_66);
         _loc3_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_135.add(AvatarType.const_66,_loc3_);
         _loc3_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc3_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_135.add(AvatarType.PET,_loc3_);
      }
      ...
      {
         var _loc9_:* = null;
         var _loc6_:* = !var_366.assetsReady(param1,param4);
         var _loc7_:String = var_366.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = var_135.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         if(!_loc6_)
         {
            return new PetImage(_loc8_,var_365,_loc7_,param4);
         }
         if(param5 != null)
         {
            _loc9_ = var_421[_loc7_];
            if(!_loc9_)
            {
               _loc9_ = [];
            }
            _loc9_.push(param5);
            var_421.add(_loc7_,_loc9_);
         }
         return new PlaceholderPetImage(_loc8_,var_365,_loc7_,param4,_assets);
      }
      ...
      public function resetPetData() : void
      {
         ...
         var_366.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = var_135.getValue(AvatarType.PET);
         _loc2_.init();
         _loc2_.resetPartOffsets();
         var _loc5_:Array = var_421.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = var_421.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = var_135.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         return var_366 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_66:
               _loc3_ = var_135.getValue(AvatarType.const_66) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_135.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc3_:AvatarStructure = var_135.getValue(AvatarType.const_66) as AvatarStructure;
      ...
      {
         var_91 = param1;
         if(var_91 == RenderMode.const_1376)
         {
            init();
         }
         if(var_91 == RenderMode.const_1281)
         {
            init();
      ...
      {
         return var_365.getAssetByName(param1);
      }
      ...
      {
         var _loc5_:AvatarStructure = var_135.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(var_232.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,var_365,_loc6_,param2,param3);
         }
         var_232.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,var_365,param2);
      }
