package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_404:PartSetsData;
      
      private var var_1510:PartOffsetData;
      
      private var var_851:AvatarActionManager;
      
      private var var_175:IAssetLibrary;
      
      private var var_852:IAssetLibrary;
      
      private var var_416:AvatarRenderManager;
      
      private var var_308:FigureData;
      
      private var var_595:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_600:String;
      
      private var var_1509:AvatarStructureDownloadSet;
      
      private var var_704:Dictionary;
      
      private var var_705:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_175 = param2;
         var_852 = param3;
         var_308 = new FigureData();
         var_404 = new PartSetsData();
         var_595 = new AnimationData();
         var_1509 = new AvatarStructureDownloadSet();
         var_705 = new AnimationManager();
         var_600 = param4;
         var_1510 = PartOffsetData.getInstance(param3);
      ...
      {
         return var_851.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_851.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_308.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_851.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_705.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_404.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_404.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1277[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_851.getDefaultAction();
         var _loc9_:Array = var_404.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_705.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_308.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_308.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_595.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_404.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_404.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_600 + " ready to go!");
         if(var_600 == AvatarType.const_66)
         {
            var_404.getPartDefinition("ri").appendToFigure = true;
            var_404.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_600)
         {
            case AvatarType.const_66:
               ...
               var_1509.add(new AvatarStructureDownload(var_175,_loc5_,var_308));
               break;
            case AvatarType.PET:
         }
         var_1509.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_705.getAnimation(param1);
      }
      ...
      {
         var_851 = new AvatarActionManager(var_175,var_600);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_704[param1] = new Dictionary();
         }
         if(var_704[param1][param2])
         {
            return var_704[param1][param2];
         }
         var_704[param1][param2] = var_308.getMandatorySetTypeIds(param1,param2);
         return var_704[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_308.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_852.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_852.getAssetByName("dance" + _loc1_).content as XML;
            var_705.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_852.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_852.getAssetByName("fx" + _loc1_).content as XML;
            var_705.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_308.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_308.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1510.loadOffsets(var_852);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_851.sortActions(param1);
      }
   }
}
