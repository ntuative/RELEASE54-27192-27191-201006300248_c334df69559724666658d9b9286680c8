package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      override public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc3_:BitmapData = getPlaceHolderImage(var_94,var_154);
         if(!_loc3_ || !_image)
         {
            return null;
         }
      ...
      override public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc2_:BitmapData = getPlaceHolderImage(var_94,var_154);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = var_535.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            var_535.add(_loc3_,_loc4_.clone());
            _loc4_ = var_535.getValue(_loc3_);
         }
         return _loc4_;
      }
