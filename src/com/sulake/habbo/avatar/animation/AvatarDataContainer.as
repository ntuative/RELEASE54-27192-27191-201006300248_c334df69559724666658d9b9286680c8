package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1558,var_1559,var_1560,_alphaMultiplier);
         var_1041 = generatePaletteMapForGrayscale(var_1787,var_1786);
      }
      
      public function get reds() : Array
      {
         return var_1041.getValue("reds") as Array;
      }
      ...
      {
         return var_1041.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1041.getValue("greens") as Array;
      }
      ...
      {
         return var_1041.getValue("alphas") as Array;
      }
