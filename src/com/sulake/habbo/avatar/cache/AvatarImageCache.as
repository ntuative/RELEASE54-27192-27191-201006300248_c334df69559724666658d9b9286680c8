package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1461:int = 60000;
      ...
      private var var_893:IAvatarImage;
      ...
      private function updateBodyPartCache(param1:String, param2:AvatarImageBodyPartCache) : void
      {
         ...
         var_126.add(param1,param2);
      }
      
      public function setGeometryType(param1:String) : void
      {
         if(var_593 == param1 || var_593 == GeometryType.const_1016 && param1 == GeometryType.const_983 || param1 == GeometryType.const_1016 && var_593 == GeometryType.const_983)
         {
            var_593 = param1;
            return;
         }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_126.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_126.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(_loc3_ == null)
         {
            method_2("[CacheMiss (getBodyPartCache)] [AvatarImageCache.getImageContainer] bodyPartId: " + param1);
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_686)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_477)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc15_ == null)
         {
            method_2("[CacheMiss (bodyPartCache.getActionCache)] [AvatarImageCache.getImageContainer] action.id: " + [param1,_loc5_.id]);
         ...
         if(_loc16_ == null)
         {
            method_2("[CacheMiss (actionCache.getDirectionCache)] [AvatarImageCache.getImageContainer] direction: " + [param1,_loc4_]);
            _loc10_ = var_82.getParts(param1,var_893.getFigure(),_loc6_,var_593,_loc4_,_loc13_,_loc14_);
         ...
         if(_loc11_ == null)
         {
            method_2("[ImageContainer (" + _loc5_.id + " " + _loc5_.definition + " type: " + _loc5_.actionType + ")]");
            _loc19_ = _loc16_.getPartList();
            _loc11_ = renderBodyPart(_loc4_,_loc19_,_loc12_,_loc5_);
            if(_loc11_ != null)
            {
               method_2("[ImageContainer creation (" + _loc5_.id + " " + _loc5_.definition + " type: " + _loc5_.actionType + ")]");
               _loc16_.updateImageContainer(_loc11_,_loc12_);
            }
            else
            {
               method_2("[ImageContainer was null: " + param1 + "]");
            }
         }
         if(_loc11_ != null)
         {
      ...
      {
         method_2("[AvatarImageCache dispose]");
         var_82 = null;
         var_893 = null;
         _assets = null;
         if(var_126 != null)
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_82.getCanvas(var_154,var_593);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1431[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               method_2("Render part: " + _loc9_);
               if(_loc8_ == null)
               {
                  return null;
               }
               if((_loc30_ == AvatarAction.const_935 || _loc30_ == AvatarAction.const_462) && (_loc6_ == AvatarBodyPartType.const_204 || _loc6_ == AvatarBodyPartType.const_1187 || _loc6_ == AvatarBodyPartType.const_1272) && _loc7_.color != null)
               {
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_126 != null)
         {
            _loc2_ = var_126.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_126.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_126 != null)
         {
            ...
            {
               _loc5_ = var_126.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
