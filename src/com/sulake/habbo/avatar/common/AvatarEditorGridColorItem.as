package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_746:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_716.width,var_716.height,true,0);
            _loc1_.bitmap.copyPixels(var_716,var_716.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_902.width,var_902.height,true,0);
            _loc5_ = var_902.clone();
            _loc5_.colorTransform(_loc5_.rect,var_746.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_747.width,var_747.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_747,var_747.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
