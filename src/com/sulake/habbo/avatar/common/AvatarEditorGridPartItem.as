package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_1549:BitmapData;
      
      private var var_415:Rectangle;
      
      private var _isDisposed:Boolean;
      
      private const const_1733:int = 13421772;
      ...
      private var var_614:IFigurePartSet;
      
      private var var_1547:int = 0;
      
      private var var_416:IAvatarRenderManager;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         var_416 = _model.controller.avatarRenderManager;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(var_415 == null)
         {
            if(!analyzePartLayers())
            {
               if(!var_1549)
               {
                  ...
                  var_1549 = _loc9_.content as BitmapData;
               }
               return var_1549;
            }
         }
         ...
         _loc1_ = new BitmapData(var_415.width,var_415.height,true,16777215);
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in _loc8_)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + const_246[_loc6_] + "_" + FigureData.const_102;
               _loc4_ = var_416.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = var_416.createFigureContainer("undefined-undefined");
         Logger.log("QUERYING SET:undefined-undefined");
         if(!var_416.isFigureReady(_loc1_))
         {
            var_416.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
