package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = var_93.getKeys();
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            _loc5_ = _loc2_[_loc4_];
            _loc6_ = var_93[_loc5_];
            _loc7_ = false;
      ...
      {
         if(!var_93 || !_controller || true)
         {
            return;
         }
         var _loc2_:CategoryData = var_93[param1];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc4_:CategoryData = var_93[param1];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:CategoryData = var_93[param1];
         if(_loc3_ == null)
         {
            return;
         }
