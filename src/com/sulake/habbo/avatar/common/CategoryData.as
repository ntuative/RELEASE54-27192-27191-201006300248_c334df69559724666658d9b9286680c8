package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private var var_767:int = -1;
      
      private var var_180:Array;
      
      private var var_209:Array;
      
      private const const_1759:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_767 >= 0 && var_180.length > var_767)
         {
            _loc2_ = var_180[var_767];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_180.length > param1)
         {
            _loc3_ = var_180[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_209.length)
         {
            ...
            {
               if(_loc7_.length > var_209[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_209[param2],param2);
         var_209[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_209[param1])
         {
            return null;
         }
      ...
      {
         return var_180[var_767] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_209 = new Array(param1.length);
         var _loc3_:int = 0;
