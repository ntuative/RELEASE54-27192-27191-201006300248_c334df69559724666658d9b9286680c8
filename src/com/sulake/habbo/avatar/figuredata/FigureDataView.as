package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_348:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1127 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_348 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_348 && var_1127)
         {
            var_348.bitmap = new BitmapData(var_348.width,var_348.height,true,16777215);
            var_348.bitmap.copyPixels(var_1127,var_1127.rect,new Point(0,0 - 0 - 8));
            var_348.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
