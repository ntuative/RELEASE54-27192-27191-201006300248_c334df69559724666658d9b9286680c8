package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1508:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_850 = new Vector3D(0,0,10,0);
         super();
         var_489 = new Matrix4x4();
         var_703 = new Dictionary();
         var_1508 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            var_703[String(_loc6_.@id)] = _loc7_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_489 = var_489.identity().rotateY(param3);
            return _loc5_.getParts(var_489,var_850,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1508.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_703[param1] as Dictionary;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_127[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_489 = var_489.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_489);
            _loc10_ = _loc8_.getDistance(var_850);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_703[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1508.findAvatarSet(param1);
         if(_loc3_ != null)
         {
