   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_231,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_220,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_pants":
                  ...
                  break;
               case "tab_shoes":
                  switchCategory(FigureData.const_231);
                  break;
               case "tab_belts":
                  switchCategory(FigureData.const_220);
            }
         }
