package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_439:ClubBuyController;
      ...
      private var var_211:PurchaseConfirmationDialog;
      
      private var var_538:IHabboSoundManager;
      
      private var var_322:CatalogViewer;
      
      private var var_2086:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_438:ICatalogNavigator;
      ...
      private var var_2085:GiftWrappingConfiguration;
      ...
      private var var_1126:ClubGiftController;
      ...
      {
         return var_370.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_104.credits = _loc3_.balance;
         updatePurse();
         if(!var_2084 && var_538 != null)
         {
            var_538.playSound(HabboSoundTypesEnum.const_886);
         }
         var_2084 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_370.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_77)
         {
            _loc3_ = var_370.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_90 == null)
         {
            return;
         }
         var_90.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_439 == null)
         {
            var_439 = new ClubBuyController(this);
         }
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_211.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_95:
               var_1366 = param1.session.isPrivateRoom;
               if(var_90 != null)
               {
                  var_90.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_107:
               ...
               if(var_90 != null)
               {
                  var_90.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_90.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_150.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2085 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_935)
         {
            if(!var_370.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_90 != null && getCurrentLayoutCode() == "recycler")
            {
               var_90.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_223,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1126.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      {
         var_90 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_438 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_104.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_104.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_104.isVIP = _loc2_.isVIP;
         var_104.pastClubDays = _loc2_.pastClubDays;
         var_104.pastVipDays = _loc2_.pastVipDays;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1126 == null)
         {
            var_1126 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_211 == null)
            {
               var_211 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_211.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_439.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_117.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_117 == null)
         {
            var_117 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_438.buildCatalogIndex(_loc2_);
         if(var_1125 != "")
         {
            var_438.openPage(var_1125);
            var_1125 = "";
         }
         else
         {
            var_438.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_322 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_322.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_90.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_104.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_104.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_104.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_104.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_322.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_104.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2086 && var_538 != null)
         {
            var_538.playSound(HabboSoundTypesEnum.const_925);
         }
         var_2086 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_322.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_322.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_322 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_322.habboCatalog = this;
      }
