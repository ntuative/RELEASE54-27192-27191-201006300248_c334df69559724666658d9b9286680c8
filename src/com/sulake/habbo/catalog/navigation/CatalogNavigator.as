package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2507:String = "magic.pixels";
      
      private var var_2506:String = "catalog.page.club";
      
      private var var_2527:String = "magic.credits";
      ...
      {
         _catalog.openCatalogPage(var_2506,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_280.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_280)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_280.indexOf(_loc6_);
            var_280.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
