package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1564:XML;
       
      
      private var var_2449:IWindowContainer;
      ...
      private var var_1565:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1564 == null)
         {
            ...
            var_1564 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1565 == 4294967295)
            {
               var_1565 = _loc1_.color;
            }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1566) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_51 = navigator.catalog.windowManager.buildFromXML(var_1564) as IItemListWindow;
         if(var_51 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1264;
            }
         }
      }
