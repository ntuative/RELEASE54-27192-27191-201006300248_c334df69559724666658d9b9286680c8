package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1469:uint = 4.294967295E9;
      
      private const const_1470:uint = 4.293848814E9;
      
      private var var_927:int;
      
      private const const_1740:uint = 4.291613146E9;
      ...
      private var var_527:IWindowContainer;
      ...
      private const const_1741:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_928;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_928,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1470) : uint(const_1469);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_469,var_79,var_1115);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_928);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_643[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_642[var_210]);
         _catalog.purchaseProductAsGift(var_469,var_79,var_1115,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_126:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_2059 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in var_246)
               {
                  ...
                  if(_loc5_.length >= const_1741)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2059 = _loc3_.text;
               break;
            case WindowMouseEvent.const_48:
               showSuggestions(false);
               if(var_1352)
               ...
               break;
            case WindowKeyboardEvent.const_566:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1603 = _loc1_.stuffTypes;
            var_643 = _loc1_.boxTypes;
            var_642 = _loc1_.ribbonTypes;
            var_928 = var_1603[0];
            _boxIndex = var_643[0];
            var_210 = var_642[0];
            initColorGrid();
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_527 == null)
         {
            var_527 = createWindow("suggestion_list_item") as IWindowContainer;
            var_527.procedure = suggestionsEventHandler;
         }
         if(var_234 == null || var_527 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_234.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_527.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
