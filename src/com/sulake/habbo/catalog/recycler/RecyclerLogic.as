package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_796:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1616)
         {
            case RecyclerStatusMessageEvent.const_1392:
               var_282 = const_367;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_837:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1444:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1616 != RecyclerStatusMessageEvent.const_837;
      }
      
      private function get statusActive() : Boolean
      {
         return var_282 != const_796;
      }
      ...
      {
         return active && var_282 == const_367;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_843:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1364:
