package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1457:String = "ctlg_";
      ...
      private var var_1382:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_869:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1457 + param1;
         ...
         var_1489 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1489) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_945);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1359) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1244) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1382;
            _loc2_.init();
         }
         var_1382.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1382.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_945);
      }
