package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1514:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_469 != null)
         {
            if(var_469.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_469.window);
            var_469.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1514);
         var_469 = _loc5_;
      ...
      {
         return var_469.dispatchWidgetEvent(param1);
      }
