package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_187:int = 31;
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_627.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = _controller.purse.pastClubDays >= const_187 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = _controller.purse.pastClubDays % const_187;
            _loc4_ = _controller.purse.pastClubDays / const_187;
         ...
         if(_loc6_)
         {
            _loc2_ = _controller.purse.pastVipDays >= const_187 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = _controller.purse.pastVipDays % const_187;
            _loc4_ = _controller.purse.pastVipDays / const_187;
            _controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            _controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      {
         if(!param1 || !param2 || !var_627 || !_controller)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_627.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(_loc6_ > 0)
         {
            ...
            _loc12_ = _loc6_ % const_187;
            _loc13_ = _loc6_ / const_187;
