package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_646[var_1121] as Array;
      ...
      {
         var _loc2_:Offer = var_646[var_1121][var_2071];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_507 || _loc1_.pricingModel == Offer.const_407)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_79)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1120.indexOf(_loc5_) == -1)
                        {
                           var_1120.push(_loc5_);
                           var_646.push(new Array());
                        }
                        _loc6_ = var_1120.indexOf(_loc5_);
                        (var_646[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_646)
         {
            if(var_2071 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2071] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1121 = var_1024.getGridItemIndex(param1.view);
