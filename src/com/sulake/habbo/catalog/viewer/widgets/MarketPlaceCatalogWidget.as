package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_926:MarketPlaceOfferData;
      
      private const const_1472:int = 1;
      
      private const const_1739:int = 40;
      ...
      private const const_1738:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_526)
         {
            ...
            var_526 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_526)
         {
            return;
         ...
         updateStatusDisplay(const_1473,_loc2_.length);
         if(!var_434)
         {
            var_434 = new Timer(25);
            var_434.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_925 = 0;
         populateList();
         var_434.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_627)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_526 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_526.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1472);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_435.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_434)
         {
            var_434.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_434 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_925 >= var_627.length)
            {
               return true;
            }
            addListItem(var_627.getWithIndex(var_925));
            ++var_925;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_926.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_126)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_435));
            _loc7_.selection = 0;
         }
      }
