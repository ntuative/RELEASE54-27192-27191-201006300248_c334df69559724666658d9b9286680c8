package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1594:Point;
      
      private var var_2030:Array;
      
      private var var_641:IItemGridWindow;
      
      private var var_89:IBitmapWrapperWindow;
      
      private var var_1467:ITextWindow;
      
      private var var_1328:IScrollbarWindow;
      
      protected var var_1256:XML;
      
      private var var_1327:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_641 != null)
         {
            var_641.visible = false;
            var_641.destroyGridItems();
         }
         if(var_1328 != null)
         {
            var_1328.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1467.text = "${" + _loc3_.name + "}";
            var_1466.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1467.text = "${" + _loc2_.localizationId + "}";
            var_1466.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_417:
                  _loc4_ = var_1327.clone();
                  if(var_641 != null)
                  {
                     var_641.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_641,var_1328,var_1256);
                  }
                  break;
               case Offer.const_507:
               case Offer.const_407:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_239:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_39,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_275,AvatarAction.const_471);
                              _loc13_.appendAction(AvatarAction.const_499,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_29,true);
      ...
      private function include(param1:AssetLoaderEvent) : void
      {
      ...
      {
         var_1467 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1466 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1594 = new Point(var_89.x,var_89.y);
         var_641 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1328 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_641 == null)
         {
         ...
         var_1327 = _loc2_.content as BitmapData;
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,include);
      }
