package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1257:XML;
      
      private var var_316:IGridItem;
      
      private var var_1256:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_869:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_722.length)
         {
            createLevelItem(var_722[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_869 = new PrizeViewer();
         var_722 = recycler.getPrizeTable();
         if(var_722 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_722[0].prizes.length > 0)
         {
            select(var_722[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1256) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_869.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
