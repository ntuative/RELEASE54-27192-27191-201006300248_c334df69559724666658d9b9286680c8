package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1096:IButtonWindow;
      
      private var var_1097:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1096 != null)
         {
            var_1096.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1097 != null)
         {
            var_1097.removeEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1096 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1096 != null)
         {
            var_1096.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1097 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1097 != null)
         {
            var_1097.addEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
