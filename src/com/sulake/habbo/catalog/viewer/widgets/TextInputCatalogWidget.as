package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1151 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1151 != null)
         {
            var_1151.addEventListener(WindowKeyboardEvent.const_566,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1151.text));
      }
   }
}
