package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      {
         ErrorReportStorage.addDebugData("Connection","Connected with " + var_853 + " attempts");
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1427,String(new Date().getTime()));
      ...
      private function nextPort() : void
      {
         ...
         {
            ++var_853;
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + var_853);
            if(var_853 > const_1728)
            {
               if(var_1766)
               {
                  return;
               ...
               var_1766 = true;
               Core.error("Connection failed to host " + var_38 + " ports " + var_267,true,Core.const_314);
               return;
            }
            var_350 = 0;
         }
         _connection.timeout = var_853 * 10000;
         _connection.init(var_38,var_267[var_350]);
      }
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_254:
               if(_habboConfiguration == null)
               {
      ...
      {
         var_309.addConnectionMessageEvent(HabboConnectionType.const_254,param1);
      }
      
      public function connectionInit(param1:String, param2:int) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1410,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1352,String(param2));
      }
      
      public function messageSent(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1403,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1230,param1 + " " + param2);
         if(false)
         {
            var_85 += ",S:" + param1;
         }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_309.registerProtocolType(HabboProtocolType.const_1023,WedgieProtocol);
            _connection = var_309.createConnection(HabboConnectionType.const_254,ConnectionType.const_1061);
            _loc3_ = var_309.getProtocolInstanceOfType(HabboProtocolType.const_1023);
      ...
      {
         var_1231.addEventListener(TimerEvent.TIMER,onTryNextPort);
         var_1231.start();
      }
      ...
      {
         return !!var_309 ? var_309.queueConnection(HabboConnectionType.const_254,param1) : null;
      }
   }
}
