package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_189:HabboHotelView;
      ...
      private var var_2323:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1690:ILogger;
      
      private var var_1450:String;
      
      private var var_2322:String;
      
      private const const_1492:String = "fuselogin";
      
      private var var_309:ICoreCommunicationManager;
      
      private var var_466:IKeyExchange;
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         if(var_1178)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_172);
         }
         var_2324 = true;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2324)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_811 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_811);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,var_1450,var_2322));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1492,"/");
      ...
      {
         var _loc4_:IConnection = var_62.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_466.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_466.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2323);
      ...
      {
         var_811 = _habboConfiguration.getKey("sso.ticket",null);
         var_1450 = _habboConfiguration.getKey("flash.client.url","");
         var_2322 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_189 == null)
         {
            var_189 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_811 != null)
         {
            var_62.mode = HabboConnectionType.const_454;
            var_62.initConnection(HabboConnectionType.const_254);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1690 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_62.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_710);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2323 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_62.mode)
         {
            case HabboConnectionType.const_454:
               ...
               var_1179 = _loc4_;
               var_189.loadBannerImage(_loc7_ + "?token=" + var_1179,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_888:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1201:
               var_674 = generateRandomHexString(30);
               var_466 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_466.init(var_674);
               _loc8_ = var_466.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_189.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1179);
         ...
         var_466 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_466.init(_loc14_);
            _loc15_ = var_466.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_62.mode = HabboConnectionType.const_888;
            }
         }
         var_62.initConnection(HabboConnectionType.const_254);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_194);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_178,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_107,onRoomSessionEnded);
      }
