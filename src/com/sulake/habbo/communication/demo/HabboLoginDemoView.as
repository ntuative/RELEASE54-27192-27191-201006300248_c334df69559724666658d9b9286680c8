package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_535:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_187.shockwaveClientUrl = var_119.shockwaveClientUrl;
         var_187.ssoTicket = var_119.ticket;
         var_119.removeEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_119.removeEventListener(SSOTicket.const_291,onParsedTicketFailure);
         var_119 = null;
         dispatchEvent(new Event(const_535));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1492,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_187.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_102,HabboWindowStyle.const_34,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_92,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1492,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_187.habboConfiguration.getKey("use.sso","false") == "true")
            {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_119 = new SSOTicket(var_187.assets,_loc2_,_loc1_);
         var_119.addEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_119.addEventListener(SSOTicket.const_291,onParsedTicketFailure);
      }
