   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_211;
               _loc14_.figure = _loc7_;
               _loc14_.webID = _loc4_;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_1022;
               ...
               _loc14_.sex = UserMessageData.const_913;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1268;
         }
         return UserMessageData.const_913;
      }
