package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1573:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_524 = getKey("url_prefix");
         if(var_524 != null && false)
         {
            setKey("client.fatal.error.url",var_524 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1435);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1102[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_524 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_524.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1586.indexOf(param1) < 0)
         {
            var_1102[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_935 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_178));
         if(var_2023)
         {
      ...
      {
         var _loc4_:String = var_1102[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_524);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1573);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1573,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
