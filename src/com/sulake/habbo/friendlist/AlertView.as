package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1535:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1275));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1535[var_1275]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
