package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1485:String = "noconvinfo";
      
      private static const const_1484:String = "messageinput";
       
      
      private var var_1636:int = -1;
      
      private var var_934:IWindowContainer;
      ...
      private var var_1399:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1399 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_934 = IWindowContainer(var_18.content.findChildByName("main_content"));
         var_294 = IWindowContainer(var_18.content.findChildByName("footer"));
         var_1399.prepare(var_934);
         var_18.procedure = onWindow;
         var_18.content.setParamFlag(HabboWindowParam.const_882,false);
         var_18.content.setParamFlag(HabboWindowParam.const_1317,true);
         var_18.header.setParamFlag(HabboWindowParam.const_728,false);
         var_18.header.setParamFlag(HabboWindowParam.const_867,true);
         var_18.content.setParamFlag(HabboWindowParam.const_728,false);
         var_18.content.setParamFlag(HabboWindowParam.const_867,true);
         var_18.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1398 = ITextWindow(var_18.findChildByName("info_text"));
         var_1398.text = "";
      ...
      public function openFriendList() : void
      {
         ...
         {
            prepare();
            _friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.FRIENDLIST,var_18));
         }
         else
         {
            var_18.visible = true;
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_294.y = Util.getLowestPoint(var_18.content);
         var_294.width = _friendList.tabs.windowWidth;
         ...
         var_18.scaler.setParamFlag(HabboWindowParam.const_926,this._friendList.tabs.findSelectedTab() != null);
         var_18.scaler.setParamFlag(HabboWindowParam.const_728,false);
         var_18.scaler.setParamFlag(HabboWindowParam.const_882,false);
         var_18.scaler.x = 0 - var_18.scaler.width;
         var_18.scaler.y = 0 - var_18.scaler.height;
         var_1637 = var_18.height;
         var_1636 = var_18.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1637 == -1 ? 0 : int(0 - var_1637);
         var _loc4_:int = var_1636 == -1 ? 0 : int(0 - var_1636);
