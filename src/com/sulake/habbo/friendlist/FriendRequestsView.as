package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1467:String = "no_reqs_info";
       
      
      private var var_1562:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1563:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_349 && _loc4_.state != FriendRequest.const_327)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_349;
      ...
      {
         var_1562 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1563 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1563.procedure = onDismissAllButtonClick;
         var_1562.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_349 && _loc4_.state != FriendRequest.const_327)
            {
               _loc4_.state = FriendRequest.const_327;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_273,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_85,param2);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1562,_loc1_);
         setEnabled(var_1563,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_349;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_327;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_273,param1));
         }
      }
   }
}
