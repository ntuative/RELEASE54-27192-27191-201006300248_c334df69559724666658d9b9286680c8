package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_140:String = "face";
       
      
      private var var_507:Timer;
      
      private var var_150:IHabboConfigurationManager;
      
      private var var_1554:OpenedToWebPopup;
      
      private var var_889:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_460:FriendListTabs;
      ...
      private var var_1555:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_618:ISessionDataManager;
      
      private var var_358:FriendRequests;
      
      private var var_1897:int;
      
      var var_93:FriendCategories;
      
      private var var_1896:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_890:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1896 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_93 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1555 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_358.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_358.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_460.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_618 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_358 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_93.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_93.addCategory(new FriendCategory(FriendCategory.const_853,getText("friendlist.friends")));
         var_93.addCategory(new FriendCategory(FriendCategory.const_456,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_93.addFriend(new Friend(_loc4_));
         }
         var_460 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_507)
         {
            var_507 = new Timer(120000);
            var_507.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_507.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_507.stop();
            var_507.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_507 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_142)
         {
            var_142.release(new IIDHabboMessenger());
            var_142 = null;
         }
         if(var_150)
         {
         ...
         if(var_890)
         {
            var_890.release(new IIDHabboNotifications());
            var_890 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_618)
         {
            var_618.release(new IIDSessionDataManager());
            var_618 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_142 = param2 as IHabboMessenger;
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = var_93.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_140) as IBitmapWrapperWindow;
      ...
      {
         var_93.onFriendListUpdate(param1);
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_460.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_348));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1555.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_358.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_93.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_618.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_618.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_358.limit)
         {
            var_358.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_460.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_39);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_358.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_460.findTab(FriendListTab.const_85);
      ...
      {
         var_890 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_93.getFriendCount(param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1554 == null)
         {
            var_1554 = new OpenedToWebPopup(this);
         }
         var_1554.show(x,y);
      }
