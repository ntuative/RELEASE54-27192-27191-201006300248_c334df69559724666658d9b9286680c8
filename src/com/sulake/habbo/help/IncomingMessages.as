package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new CallForHelpPendingCallsDeletedMessageEvent(method_17));
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_24.tellUI(HabboHelpViewEnum.const_209,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_247,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_141);
      }
      ...
      private function method_17(param1:IMessageEvent) : void
      {
         var_24.showUI(HabboHelpViewEnum.const_301);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_24.showUI(HabboHelpViewEnum.const_481);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_24.showUI(HabboHelpViewEnum.const_694);
         var_24.tellUI(HabboHelpViewEnum.const_694,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_336)
            {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_692);
      }
