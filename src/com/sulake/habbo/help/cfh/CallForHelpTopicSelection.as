package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1105:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_748 == null || _loc3_ < 0 || _loc3_ >= var_748.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_748[_loc3_];
            main.showUI(HabboHelpViewEnum.const_532);
            main.tellUI(HabboHelpViewEnum.const_532,null);
         }
      }
   }
}
