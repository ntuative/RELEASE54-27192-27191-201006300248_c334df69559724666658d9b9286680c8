package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_247.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_247.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_247.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_247.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_247 != null)
               {
                  _loc3_ = var_247.category;
                  main.showUI(HabboHelpViewEnum.const_247);
                  main.tellUI(HabboHelpViewEnum.const_247,_loc3_);
               }
               break;
            case "help_faq_next_entry":
               if(getNextItem() != null)
               {
                  main.tellUI(HabboHelpViewEnum.const_209,getNextItem());
               }
               break;
            default:
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || var_247 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = var_247.category;
         if(_loc2_ == null)
         {
            return null;
         }
