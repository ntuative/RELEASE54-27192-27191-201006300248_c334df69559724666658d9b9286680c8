package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1154:int = 60;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "help_cfh":
               ...
               main.showUI(HabboHelpViewEnum.const_301);
               break;
            case "help_report_user":
               main.component.callForHelpData.reportedUserId = 0;
               main.showUI(HabboHelpViewEnum.const_692);
            case "item_bg":
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ == null || _loc1_.getFrontPageUrgentCategory().getAgeSeconds() > const_1154)
         {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_209);
            main.tellUI(HabboHelpViewEnum.const_209,_loc6_);
         }
      }
   }
}
