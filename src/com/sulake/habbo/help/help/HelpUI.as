package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","27192-27191-201006300239");
         _toolbar = param5;
         var_109 = new Map();
         var_109.add(HabboHelpViewEnum.const_1204,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_141,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_481,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_247,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_209,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_694,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_301,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_532,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_212,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_109.add(HabboHelpViewEnum.const_902,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_692,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_285 == HabboHelpViewEnum.const_141 || false)
         {
            return;
         }
         if(var_441 == null)
         {
            ...
            var_441 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_441 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_441 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_441 as IWindow);
      ...
      {
         return var_109.getValue(var_285);
      }
      ...
      {
         var_2102 = param1;
         var _loc2_:IHelpViewController = var_109.getValue(HabboHelpViewEnum.const_141) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1012:
               showUI(HabboHelpViewEnum.const_902);
               break;
            case CallForHelpResultEnum.const_1028:
      ...
      {
         var _loc3_:* = null;
         if(var_285 == HabboHelpViewEnum.const_141)
         {
            return;
         }
         if(true)
         {
            ...
            var_658.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_658.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_441.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_658[1],var_658[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_658[0],var_658[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1622;
         _window.width = _loc1_.width + var_1621;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_285);
            return;
         }
         ...
         if(_loc3_)
         {
            if(_toolbar != null)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_24.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_504));
      }
