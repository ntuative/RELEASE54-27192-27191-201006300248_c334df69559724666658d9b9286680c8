package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_309:String = "TUI_CLOTHES_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_504,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_379,onTaskDoneEvent);
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_35 != null && (var_35.id == const_240 || var_35.id == const_88))
         {
            showView(const_88);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1622;
         _window.width = _loc2_.width + var_1621;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_504,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_379,onTaskDoneEvent);
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_504:
               var_1188 = true;
               if(var_35 != null && var_35.id == const_488)
               {
                  showView(const_88);
               }
               break;
            case HabboHelpTutorialEvent.const_379:
               if(var_35 != null && var_35.id == const_309)
               {
                  var_1465 = true;
                  disposeWindow();
               }
      ...
      {
         var_1187 = true;
         if(var_35 != null && (var_35.id == const_309 || var_35.id == const_88))
         {
            showView(const_88);
         }
      }
      ...
      {
         return var_1187 && var_1186 && var_1188;
      }
   }
}
