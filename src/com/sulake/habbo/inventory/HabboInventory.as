package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1004:IRoomSession;
      ...
      private const const_1755:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_20 != null)
         {
            var_20.events.removeEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionEvent.const_107,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_430,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_107:
               var_1004 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_430:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_50.getValue(InventoryCategory.const_666));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_50.getValue(InventoryCategory.const_76));
      }
      ...
      {
         var_104.clubPeriods = param1;
         var_104.clubDays = param2;
         var_104.clubHasEverBeenMember = param3;
         var_104.isVIP = param4;
      ...
      {
         return PetsModel(var_50.getValue(InventoryCategory.const_149));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_950));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1755);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_50.getValue(InventoryCategory.const_333));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_280:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_1003.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_1003.splice(_loc3_,1);
            }
         }
      }
      ...
      public function get clubLevel() : int
      {
         ...
         return HabboClubLevelEnum.const_57;
      }
      ...
      {
         return TradingModel(var_50.getValue(InventorySubCategory.const_280));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_370 = ISessionDataManager(param2);
      ...
      {
         return var_104.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_50.getValue(InventoryCategory.const_356) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1185 = new IncomingMessages(this);
      ...
      {
         return var_104.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_104.clubPastPeriods;
      }
      ...
      {
         var_20 = IRoomSessionManager(param2);
         var_20.events.addEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionEvent.const_107,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_430,roomSessionEventHandler);
         ...
         var_50.add(InventoryCategory.const_356,_loc3_);
         ...
         var_50.add(InventoryCategory.const_76,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_370);
         ...
         var_50.add(InventoryCategory.const_666,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_370);
         var_50.add(InventoryCategory.const_333,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_50.add(InventorySubCategory.const_280,_loc8_);
         ...
         var_50.add(InventoryCategory.const_149,_loc10_);
