package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_76,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_666);
         _loc2_.refreshViews();
         var_14.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_176)
            {
      ...
      {
         var _loc2_:* = null;
         if(var_14.isInventoryCategoryInit(InventoryCategory.const_356))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_149);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_14.setInventoryCategoryInit(InventoryCategory.const_333);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_76);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_14.toggleInventorySubPage(InventorySubCategory.const_280);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_356);
         var _loc4_:FurniModel = var_14.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
