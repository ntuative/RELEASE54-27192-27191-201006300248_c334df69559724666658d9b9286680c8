package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1423:IWindowContainer;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1423);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_797 == InventoryCategory.const_149)
            {
               toggleCategoryView(InventoryCategory.const_149);
            }
            else if(var_797 == InventoryCategory.const_76)
            {
               toggleCategoryView(InventoryCategory.const_76);
            }
            else if(_controller != null)
            {
               _controller.toggleInventoryPage(InventoryCategory.const_76);
            }
         }
      }
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(_toolbar != null && var_966)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_680,HabboToolbarIconEnum.INVENTORY,var_18 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(_toolbar != null && var_966)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_966 = false;
         }
         _controller.inventoryViewOpened(var_798);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_797 || !_controller.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(_toolbar != null && var_966)
