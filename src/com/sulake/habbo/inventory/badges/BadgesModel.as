package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1752:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_960.length)
         {
            if(var_960[_loc2_] == param1)
            {
               var_960.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_292[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_292.length)
               {
                  if((var_292[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_292[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_370.getBadgeImage(param1);
            var_292.push(_loc8_);
            if(param2)
            {
