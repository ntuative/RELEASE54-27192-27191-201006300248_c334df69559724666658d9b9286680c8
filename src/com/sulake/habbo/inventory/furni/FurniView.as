package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_764:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_533 = new Map();
         var_533.add(FurniModel.const_38,new FurniGridView(_model,FurniModel.const_38,_windowManager,_assetLibrary,_roomEngine));
         var_533.add(FurniModel.const_41,new FurniGridView(_model,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_54)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_358);
            }
         }
      }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_533.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_533.getValue(var_532);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_38,FurniModel.const_41];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_532);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_321)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_176)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_764 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_533.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
