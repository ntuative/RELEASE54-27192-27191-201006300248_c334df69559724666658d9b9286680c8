package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2428:BitmapData;
      
      protected var var_1027:Boolean;
      ...
      protected var var_482:int = 0;
      
      protected var var_1487:String;
      
      private const const_1733:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_397:BitmapData;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_713)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1661));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1487);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1490 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2428;
               _loc5_.visible = true;
            }
            else
            {
