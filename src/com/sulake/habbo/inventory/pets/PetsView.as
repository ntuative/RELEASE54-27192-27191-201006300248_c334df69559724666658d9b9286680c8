package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_553 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_620 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_620.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_620.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_553.removeGridItem(_loc2_.window);
         if(var_316 == _loc2_)
         {
            var_316 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_620.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_553.addGridItem(_loc2_.window);
            var_620.add(param1.id,_loc2_);
            if(var_316 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         else
         {
            ...
            _loc13_.setDirection(AvatarSetType.const_29,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_29);
            _loc3_ = _loc12_.name;
