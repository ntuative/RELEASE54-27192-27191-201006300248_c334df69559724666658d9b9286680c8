package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_803:uint = 4284532064;
      
      private static const const_802:uint = 2577770;
      
      public static const const_890:int = 0;
      ...
      private var var_381:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_381 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_176)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_883)
            {
            ...
            var_381.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_440);
            var_381.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_186)
            {
               var_186.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_186.stop();
               var_186 = null;
            }
            if(var_381 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1631 == null)
         {
            var_1631 = createMinimizedWindow();
         }
         if(!var_2127)
         {
            return var_66;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_186 == null)
         {
            var_186 = new Timer(1000,3);
            var_186.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_186.reset();
         var_186.repeatCount = 3;
         var_186.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_803) : uint(const_802);
            }
