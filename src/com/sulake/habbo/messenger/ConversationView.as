package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1152:int = 10;
      
      private static const const_1153:int = 20;
      
      private static const const_810:int = 100;
       
      
      private var var_2168:IScrollbarWindow;
      
      private var var_142:HabboMessenger;
      
      private var var_1645:IContainerButtonWindow;
      
      private var var_556:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_142 = param1;
         var_1645 = initButton("follow_friend",onFollowButtonClick,param2);
         var_51 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2168 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_142.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_142.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_653 || param3.type == Message.const_748 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_556.messages.length - const_810);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_556.messages.length)
         {
            refreshEntry(true,_loc1_,var_556.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_556 == null || _loc1_.id != var_556.id)
         {
            var_556 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_810 + const_1153)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_142.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_142.send(new FollowFriendMessageComposer(var_556.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_142.getButtonImage(param1);
      ...
      {
         if(param1 == Message.const_653)
         {
            return 4294967295;
         }
         if(param1 == Message.const_748)
         {
            return 4292801535;
         }
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_142.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_142.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1152;
         param1.invalidate();
      }
   }
}
