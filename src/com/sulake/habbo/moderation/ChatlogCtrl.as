package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1512:IMessageComposer;
      ...
      {
         var_885 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_886 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1512);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_885.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_886.clone());
         _loc4_.color = var_1286[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
