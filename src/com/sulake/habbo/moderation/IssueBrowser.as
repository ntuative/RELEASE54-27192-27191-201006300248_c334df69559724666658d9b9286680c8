package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1705:IIssueBrowserView;
      
      private const const_1758:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1756:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1706:IIssueBrowserView;
      
      private const const_1761:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1757:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_254:ITabContextWindow;
      
      private var var_1707:PickedIssuesView;
      
      private var var_393:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_254 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_254.numTabItems)
            {
               _loc5_ = var_254.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_54,onTabSelected);
               _loc6_++;
            }
         }
         var_254 = _window.findChildByName("tab_context") as ITabContextWindow;
         if(var_254 == null || true)
         {
            return;
         }
         var _loc1_:ISelectableWindow = var_254.selector.getSelectableByName("open_issues");
         var_254.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_393.view.width = var_254.container.width;
         var_393.view.height = var_254.container.height;
         var_393.visible = true;
         var_393.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1757:
               if(var_1706 == null)
               {
                  var_1706 = new MyIssuesView(issueManager,this,var_254.container);
               }
               return var_1706;
            case const_1758:
               if(var_1705 == null)
               {
                  var_1705 = new OpenIssuesView(issueManager,this,var_254.container);
               }
               return var_1705;
            case const_1756:
               if(var_1707 == null)
               {
                  var_1707 = new PickedIssuesView(issueManager,this,var_254.container);
               }
               return var_1707;
            default:
               return null;
