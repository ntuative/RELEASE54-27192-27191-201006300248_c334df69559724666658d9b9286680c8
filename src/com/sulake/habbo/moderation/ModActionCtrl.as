package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_720:OffenceCategoryData;
      ...
      private var var_866:IDropMenuWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_868 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_867 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_866.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1253,var_410.text,getBanLength(),var_1254));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_866.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1253,var_410.text,var_1254));
         this.dispose();
      }
      ...
      {
         return WindowTracker.const_1439;
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_720 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1253,var_410.text,var_1254));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_720 != null;
         if(this.var_721 != null)
         {
            var_53.findChildByName("offence_txt").caption = this.var_721.name;
            var_53.findChildByName("offence_category").visible = true;
         }
         else if(this.var_720 != null)
         {
            this.refreshButtons("offences_cont",2,var_720.offences,var_868,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_867,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_721 = var_720.offences[_loc3_];
         var_410.text = var_721.msg;
         var_333 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_53.caption = "Mod action on: " + var_1522;
         ...
         var_866 = IDropMenuWindow(var_53.findChildByName("banLengthSelect"));
         prepareBanSelect(var_866);
