package com.sulake.habbo.moderation
{
   ...
   public class PickedIssuesView implements IIssueBrowserView
   {
      ...
      private var var_2036:IssueListView;
      ...
      public function PickedIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         var_679 = param2;
         _window = var_679.createWindow("picked_issues_xml") as IWindowContainer;
         param3.addChild(_window);
         var _loc4_:IItemListWindow = _window.findChildByName("issue_list") as IItemListWindow;
         var_2036 = new IssueListView(param1,param2,_loc4_,"picked_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = _issueManager.getBundles(IssueManager.const_842);
         var_2036.update(_loc1_);
      }
   }
}
