package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      public static function method_3(param1:IWindowContainer, param2:int, param3:int) : void
      {
         var _loc5_:* = null;
         var _loc4_:int = 0;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_577,_data.flatId),var_53,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_461);
         if(param1.flatId != var_461)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_461);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1365,_loc2_,var_410.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1046.isSelected,var_1047.isSelected,var_717.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1446);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1217);
      }
      ...
      public function populate() : void
      {
         ...
         var_717 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1046 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1047 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_461));
         Logger.log("BEGINNING TO SHOW: " + var_461);
      }
   }
}
