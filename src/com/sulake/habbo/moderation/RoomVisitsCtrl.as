package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2169:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2169.clone());
      ...
      {
         var_2169 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1370;
      }
   }
}
