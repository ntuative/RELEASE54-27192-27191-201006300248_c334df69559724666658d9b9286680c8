package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_577:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1439:int = 7;
      ...
      {
         var_1625 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1625[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1625[param1] = _loc2_;
         }
         return _loc2_;
      }
