package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomPasswordInput
   {
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:IButtonWindow = _window.findChildByName("HabboAvatarEditorCom_editor_clr_40x32_2") as IButtonWindow;
         if(_loc2_ != null)
         {
      ...
      private function onTry(param1:WindowMouseEvent) : void
      {
         ...
         _navigator.goToRoom(var_938.flatId,true,_loc3_);
         hide();
      }
