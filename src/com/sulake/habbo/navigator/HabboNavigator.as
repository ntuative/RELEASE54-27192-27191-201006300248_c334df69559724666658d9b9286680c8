package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2521:Dictionary;
      ...
      private var var_870:RoomCreateViewCtrl;
      ...
      private var var_497:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_460:Tabs;
      
      private var var_271:MainViewCtrl;
      
      private var var_1824:Array;
      
      private var var_1164:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_271 = new MainViewCtrl(this);
         var_497 = new RoomInfoViewCtrl(this);
         var_870 = new RoomCreateViewCtrl(this);
         var_1823 = new RoomThumbnailRenderer(this);
         var_1164 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_460 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_271.startSearch(Tabs.const_202,Tabs.const_305,param1);
         var_271.mainWindow.activate();
      }
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(var_20)
         {
            ...
            var_497.close();
            var_20.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            var_497.close();
            var_20.gotoRoom(true,param1,"",param2);
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_497.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_271.startSearch(Tabs.const_284,Tabs.const_226);
         var_460.getTab(Tabs.const_284).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_271.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
