package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_170,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
