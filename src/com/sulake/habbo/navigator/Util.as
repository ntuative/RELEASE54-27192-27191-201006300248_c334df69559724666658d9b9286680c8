package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1609:CutToHeight = new CutToHeight();
      
      private static var var_1610:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1609.beforeSearch(param2,param1,param3);
         binarySearch(var_1609,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1610.beforeSearch(param2,param1,param3);
         binarySearch(var_1610,param2.length - 1);
      }
   }
}
