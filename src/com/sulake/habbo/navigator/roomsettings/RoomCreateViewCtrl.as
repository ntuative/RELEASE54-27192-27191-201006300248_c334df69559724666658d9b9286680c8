package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1390:Boolean = true;
      
      private var var_950:RoomLayout;
      ...
      private var var_1137:TextFieldManager;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         var_41 = new Array();
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,104,"a"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,94,"b"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,36,"c"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,84,"d"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,80,"e"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,80,"f"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,416,"i"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,320,"j"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,448,"k"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,352,"l"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,384,"m"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_43,372,"n"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,80,"g"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,74,"h"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,416,"o"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,352,"p"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,304,"q"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,336,"r"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,748,"u"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_57,438,"v"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_46,540,"t"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_46,512,"w"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_46,396,"x"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_46,440,"y"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_46,456,"z"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_46,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1137 = new TextFieldManager(_navigator,ITextFieldWindow(var_22.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         var_1137.goBackToInitialState();
         var_1137.input.textBackgroundColor = 4294967295;
         var_950 = var_41[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_51,HabboWindowStyle.const_36,HabboWindowParam.const_71,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1137.getText();
      ...
      {
         var _loc1_:Boolean = var_1137.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_950.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1390 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1390 = true;
            _loc3_.y = 1;
