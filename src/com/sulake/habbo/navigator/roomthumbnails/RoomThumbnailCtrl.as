package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2314:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1686,this._model.mode != ThumbnailEditorModel.const_50);
         setEnabled(var_1685,this._model.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1686 = IButtonWindow(find("top_tab"));
         var_1685 = IButtonWindow(find("obj_tab"));
         var_2314 = IWindowContainer(find("tile_grid"));
         var_2315 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1686,onTopTabButton);
         Util.setProcDirectly(var_1685,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2314;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2315;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_51,HabboWindowStyle.const_36,HabboWindowParam.const_71,new Rectangle(0,0,param1.width,66)));
