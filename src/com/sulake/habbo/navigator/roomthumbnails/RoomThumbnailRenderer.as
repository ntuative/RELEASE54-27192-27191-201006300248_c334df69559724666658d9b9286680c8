package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1076:int = -16;
      
      private static const const_772:int = 32;
      
      private static const const_1075:int = 8;
      
      public static const const_438:int = 10;
      
      private static const const_1077:int = 40;
      ...
      private var var_1235:BitmapData;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1076,_loc4_.y + const_1077 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1776[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = this.var_854.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_50,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_772 / 2);
         return new Point(param1 * const_772 + _loc3_,param2 * const_1075);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         {
            var_1039[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1039[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_438)
         {
            if(false)
            {
               refreshObj(param1,var_1039[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1235 == null)
         {
            var_1235 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1235,var_1235.rect,new Point(0,0),null,null,true);
      }
   }
}
