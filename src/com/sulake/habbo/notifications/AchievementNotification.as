package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_220 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1955 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_220);
      ...
      public function dispose() : void
      {
         if(var_370 != null)
         {
            var_370.events.removeEventListener(BadgeImageReadyEvent.const_130,onBadgeImageReady);
            var_370 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_743,var_1955);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_743,var_743));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_743,var_743));
         _localizations.registerParameter(param1,"level",var_1805.toString());
         _localizations.registerParameter(param1,"name",var_370.userName);
         _localizations.registerParameter(param1,"realname",var_370.realName);
      }
   }
}
