package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1118:String = "badges";
      
      private static const const_1120:String = "pet_inventory";
      
      private static const const_1122:String = "pixelbalance";
      
      private static const const_1125:String = "credits";
      
      private static const const_1124:String = "inventory";
      
      private static const const_1123:String = "friendlist";
      
      private static const const_1119:String = "selectfurni";
      
      private static const const_1121:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_637:ParkBusDialogManager;
      
      private var var_638:IHabboToolbar;
      ...
      private var var_754:ClubEndingNotification;
      ...
      private var var_753:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_914);
         }
         var _loc6_:Map = var_914["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1236);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_753 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_843)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1309);
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_638)
         {
            var_638.release(new IIDHabboToolbar());
            var_638 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_77:
               ...
               break;
            case CatalogPageMessageProductData.const_239:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1257);
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1120:
               if(var_14)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_149);
               }
               break;
            case const_1119:
               break;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_877,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_458.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_29,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_39);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1017,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_164 || param2.type == WindowEvent.const_583)
         {
            param1.dispose();
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_637 == null)
         {
            var_637 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_637 != null)
         {
            var_637.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1103.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_458.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_370);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc9_ = var_370.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc9_ = var_370.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_370.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1443,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_458.createAvatarImage(param2,AvatarScaleType.const_49);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_39,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_39);
            _loc7_.dispose();
         }
         if(param3 == "")
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1103.push(_loc8_);
         return var_1103.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1433)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_754 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_638 = IHabboToolbar(param2);
         var_638.events.addEventListener(HabboToolbarEvent.const_82,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_370.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_1020);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_1020);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_321;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_82)
         {
            ...
            var_428 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_914["styles"],var_914["view"],var_638);
            ...
            var_370.events.addEventListener(BadgeImageReadyEvent.const_130,onBadgeImage);
            var_638.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
