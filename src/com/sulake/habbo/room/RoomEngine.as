package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_526:String = "room";
      
      private static const const_830:int = -2;
      
      private static const const_525:String = "temporary_room";
      
      private static const const_298:String = "object_icon_sprite";
      
      private static const const_829:int = -3;
      
      private static const const_831:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1185:String = "tile_cursor";
      ...
      private var var_687:NumberBank;
      
      private var var_44:IRoomManager = null;
      ...
      private var var_832:RoomMessageHandler = null;
      
      private var var_831:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_340 = new Map();
         var_687 = new NumberBank(1000);
         var_1195 = new Map();
         var_341 = new Map();
         var_70 = new RoomObjectEventHandler(this);
         var_832 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_70 != null)
         {
            ...
            {
               return var_70.deleteWallItem(var_124,var_123,param1);
            }
         }
         return false;
      }
      ...
      private function getRoomCanvas(param1:int, param2:int, param3:int) : IRoomRenderingCanvas
      {
         ...
         var _loc5_:IRoomInstance = var_44.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_340.length; _loc2_++)
         {
            _loc3_ = var_340.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_613) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_626) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_564) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_718) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc5_:int = method_14(param1);
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_100);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return var_70.modifyWallItemData(var_124,var_123,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_467 != null)
         {
            var_467.release(new IIDRoomObjectVisualizationFactory());
            var_467 = null;
         }
         if(var_44 != null)
         {
            var_44.release(new IIDRoomManager());
            var_44 = null;
         }
         if(var_831 != null)
         {
            var_831.release(new IIDRoomRendererFactory());
            var_831 = null;
         }
         ...
         if(var_340 != null)
         {
            ...
            {
               _loc2_ = var_340.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc4_:IRoomInstance = var_44.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = var_44.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_831.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1049;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_592);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_591);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_618);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1006);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_916) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_857);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_491,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_722,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_579,var_124,var_123,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            return var_70.modifyRoomObject(var_124,var_123,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_341.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_341.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_44 = param2 as IRoomManager;
         if(var_44 != null)
         {
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_26);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_33);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_258);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_58);
            var_44.setContentLoader(var_15);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_70 != null)
         {
            var_70.handleRoomObjectEvent(param1,var_124,var_123);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_15.sessionDataManager = var_370;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_206,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_319,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_323,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_875,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1053,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_989,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_262,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_627,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_29 == null || var_467 == null || var_44 == null || var_831 == null || _communication == null || _habboConfiguration == null || !var_2400)
         {
            return;
         }
         var_44.initialize(<nothing/>,this);
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_297,RoomObjectCategoryEnum.const_58);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1379,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         if(var_44 != null)
         {
            var_44.update(param1);
         }
         updateRoomCameras(param1);
         var _loc2_:IRoomInstance = var_44.getRoom(getRoomIdentifier(var_124,var_123));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_829,RoomObjectCategoryEnum.const_258);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_124,var_123,var_1480);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_124,var_123,var_1480);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_467 = param2 as IRoomObjectVisualizationFactory;
         if(var_15 != null)
         {
            var_15.visualizationFactory = var_467;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_29 != null)
         {
            if(false)
            {
               var_29.events.addEventListener(RoomObjectMouseEvent.const_215,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_432,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_479,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_177,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_646,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_111,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_96,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_437,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_463,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_509,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_387,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_452,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_457,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_445,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_461,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_55,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_377,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_412,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_266,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_464,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_299,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_338,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_465,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_903,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_424,roomObjectEventHandler);
               var_29.events.addEventListener(AvatarWalkWarpingWarningEvent.const_446,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_124,var_123);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_571) != 0)
         {
            return false;
         }
         if(var_70 != null)
         {
            return var_70.initializeRoomObjectInsert(var_124,var_123,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_583 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_712,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_341.length)
            {
               _loc3_ = var_341.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_262,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      {
         return var_44.isContentAvailable(param1);
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = var_44.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_206));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_473);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_355);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_623)
         {
            var_2400 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_206,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_319,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_323,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1049,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_262,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      private function method_14(param1:String) : int
      {
         return 1;
      }
      ...
      {
         var _loc5_:IRoomInstance = var_44.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_274.events.addEventListener(AdEvent.const_500,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_831) as Sprite;
      }
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var_44.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = var_340.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_569,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_831 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = var_44.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_583 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_44.getRoom(const_525);
         if(_loc10_ == null)
         {
            _loc10_ = var_44.createRoom(const_525,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_687.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_206,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_473,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
            ...
            case RoomObjectCategoryEnum.const_58:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_180,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_681,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_633,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_491,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1195.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1005,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_687.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_830,RoomObjectCategoryEnum.const_258);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_124,var_123,param1);
         if(_loc9_ != null)
         {
            var_1480 = param1;
            var_1718 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1718 - _loc12_.width / 2;
               _loc11_.y = var_1719 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_409,var_124,var_123,-1,RoomObjectCategoryEnum.const_234));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_70 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_297,const_526);
                  var_70.handleRoomObjectEvent(_loc14_,var_124,var_123);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_124,var_123,param1,param2,new Vector3d(),1,null);
         }
         else if(var_15 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_124,var_123,var_1480);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1718 - _loc6_.data.width / 2;
               _loc11_.y = var_1719 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_15 != null)
         {
            ...
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_328,param1.image,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_931,param1.adWarningL,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1019,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_908,RoomObjectVariableEnum.const_328,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_340.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_340.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_15 != null)
         {
            _events.addEventListener(RoomContentLoader.const_623,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_70 != null)
         {
            var_70.cancelRoomObjectInsert(var_124,var_123);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_44.getRoom(const_525);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1005);
               ...
               var_687.freeNumber(_loc10_ - 1);
               _loc13_ = var_1195.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_124,var_123,const_297,RoomObjectCategoryEnum.const_58,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = var_44.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_922,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_571,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_930,_loc13_,true);
            if(var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_297,const_526,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_571,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_592,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_613,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_564,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_626,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_718,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_851,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_491,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_213);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_591,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_618,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_591,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_618,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1006,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_830,const_1185,RoomObjectCategoryEnum.const_258);
         _loc7_.createRoomObject(const_829,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_258);
         return _loc7_;
      }
