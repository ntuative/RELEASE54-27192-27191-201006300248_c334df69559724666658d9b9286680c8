package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1055:int = -1.0E9;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1033,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_592);
         var _loc8_:int = 0;
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:RoomObjectAvatarWaveUpdateMessage = new RoomObjectAvatarWaveUpdateMessage(_loc3_.method_5);
         var_13.updateObjectUserState(_loc3_.roomId,_loc3_.roomCategory,_loc3_.userId,_loc4_);
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_964:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_928:
                     _loc10_ = "std";
               }
