package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1135:int = 0;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_1034 / _loc3_.state;
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            var_1604.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),var_1604).length > 0)
            {
               if(object.getState(0) != const_795)
               {
                  object.setState(const_795,0);
               }
            }
            else
            {
               object.setState(const_1135,0);
            }
         }
      }
   }
