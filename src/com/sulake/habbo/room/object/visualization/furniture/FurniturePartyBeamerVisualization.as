package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_788:int = 15;
      
      private static const const_1110:int = 2;
      
      private static const const_361:int = 2;
      
      private static const const_789:int = 31;
      
      private static const const_1109:int = 1;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1091[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1090[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1091 = new Array();
         var_1091.push(Math.random() * _loc2_ * 1.5);
         var_1091.push(Math.random() * _loc2_ * 1.5);
         var_1089 = new Array();
         var_1089.push(1);
         var_1089.push(-1);
         ...
         var_1090 = new Array();
         var_1090.push(getRandomAmplitudeFactor());
         var_1090.push(getRandomAmplitudeFactor());
      }
