package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_905);
      ...
      {
         if(param1 < var_683.length)
         {
            return var_683[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_253 != null)
         {
            ...
            {
               _loc2_ = var_253[_loc3_];
               _loc2_.update(var_683,var_2360,param1);
               _loc3_++;
            }
