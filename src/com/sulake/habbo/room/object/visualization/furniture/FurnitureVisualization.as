package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1575:String = null;
      ...
      private var var_1310:Boolean = true;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_631[param1] = _loc3_;
            var_632[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1575 != null && var_1575.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      {
         var _loc3_:int = 0;
         if(var_1999 != param1 || var_1998 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_631[_loc3_] = "";
               var_632[_loc3_] = false;
               _loc3_--;
            }
            var_1999 = param1;
            var_1998 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2001 != param1 || var_2000 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2425 = _loc3_.getNumber(RoomObjectVariableEnum.const_206);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_232));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1575 = _loc3_.getString(RoomObjectVariableEnum.const_323);
