package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1097:String = "shore";
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = var_502 + 2;
         var _loc4_:int = var_613 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               var_503[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function resetBorders() : void
      {
         ...
         if(var_502 == 0 || var_613 == 0)
         {
            ...
            var_502 = _loc2_.getNumber(RoomObjectVariableEnum.const_263);
            var_613 = _loc2_.getNumber(RoomObjectVariableEnum.const_337);
         }
         var_356 = [];
         var_503 = [];
         var _loc1_:int = 0;
         while(_loc1_ < var_502 * 2 + var_613 * 2)
         {
            var_356.push(false);
            var_503.push(ShoreMaskCreatorUtility.const_68);
            _loc1_++;
         }
      }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               var_503[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc1_:int = var_502 + 2;
         var _loc2_:int = var_613 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(var_1879 == param1 && var_1880 == _direction)
         {
            return var_1545;
         }
         var_1879 = param1;
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1097)
            {
               var_1545 = _loc2_;
               break;
            }
      ...
      {
         if(var_64 == null || var_64.width < param1 || var_64.height < param2)
         {
            if(var_64 != null)
            {
               var_64.dispose();
            }
            var_64 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(var_64,getSize(param3),var_356,var_503,assetCollection);
      }
