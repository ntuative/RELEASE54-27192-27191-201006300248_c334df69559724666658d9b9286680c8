package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_68:int = 1;
      
      private static const MASK_COLOR_TRANSPARENT:uint = 0;
      
      private static const const_1166:int = 3;
      ...
      {
         return param1 + param2 * const_1166;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_132,const_68,const_64,const_132,const_68,const_64];
                     _loc8_ = [const_68,const_68,const_68,const_64,const_64,const_64];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
