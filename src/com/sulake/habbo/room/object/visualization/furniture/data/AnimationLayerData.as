package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_214[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1507)
         {
            _loc4_ = param1 / var_377;
            param1 %= var_377;
            if(var_1376 > 0 && _loc4_ >= var_1376 || var_1376 <= 0 && var_377 == 1)
            {
               param1 = var_377 - 1;
               _loc3_ = true;
            }
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_214.length)
            {
               _loc2_ = var_214[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_214[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_214.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_214[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
