package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1082:Point = null;
      
      private var var_511:Array;
      
      private var var_1081:LayoutRasterizerData = null;
      ...
      private var var_510:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_1007:IGraphicAssetCollection;
      
      private var var_1455:XMLList;
      ...
      {
         var_510 = true;
         var _loc3_:int = var_364.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_364.push(param1);
            var_509.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1083 = param1;
         var _loc3_:LayoutRasterizerData = var_41.getValue(var_742);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1299 = RoomObjectVariableEnum.const_931;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1299 = RoomObjectVariableEnum.const_1019;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1083 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1083 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1083 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1083 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1299);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_475;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1935);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_742)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1081 = var_41.getValue(var_742);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_41.getValue(var_742);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1081.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_1007.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1082.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1082.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_364.indexOf(_loc10_) >= 0 && var_510)
            {
               param1 = var_364.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_1007.getAsset(var_509[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_511[param1];
               }
               var_364.splice(param1,1);
               var_509.splice(param1,1);
               var_511.splice(param1,1);
               if(false)
               {
                  var_510 = false;
               }
