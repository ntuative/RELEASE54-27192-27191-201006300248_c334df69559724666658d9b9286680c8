package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1279:int = const_340;
      ...
      public static const const_228:int = 4;
      
      public static const REPEAT_MODE_RANDOM:int = 6;
      
      public static const const_260:int = const_110;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_387[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1666 == const_110)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_386);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_386,var_26.width,var_386);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_661,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_386,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_387.length)
         {
            _loc11_ = var_387[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         var_386 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_387.length)
         {
            _loc2_ = var_387[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_387.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_387[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_387[param1] = _loc5_;
