package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1636:int = 16777216;
      
      public static const const_1523:int = 1;
       
      
      private var var_2511:int = 69069;
      
      private var var_1391:int = 1;
      
      private var var_2510:int = 5;
      
      private var var_1630:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1630 * param2);
      }
      ...
      {
         var _loc1_:int = var_2511 * var_1391 + var_2510;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
