package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1111:UserDataManager;
      ...
      {
         if(var_37 == RoomSessionEvent.const_300 && _connection != null)
         {
            var_37 = RoomSessionEvent.const_95;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1111 as IUserDataManager;
      }
