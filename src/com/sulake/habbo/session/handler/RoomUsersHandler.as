package com.sulake.habbo.session.handler
{
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_103,_loc3_,_loc2_.userName));
      }
      ...
      private function onEnabledPetCommands(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            listener.events.dispatchEvent(new RoomSessionPetCommandsUpdateEvent(_loc2_,_loc4_.petId,_loc4_.method_6));
         }
      }
