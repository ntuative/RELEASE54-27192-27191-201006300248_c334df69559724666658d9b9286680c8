package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_309.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_131,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1007,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_170,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_449,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_680,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_956,onHideWindowEvent);
         var_37 = true;
