package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1142:Number = 90;
      
      private static const const_801:int = 50;
      
      private static const const_1141:Number = 25;
      
      private static const const_1143:int = 50;
      ...
      private var var_1132:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1132 = param2;
         var_655 = new Timer(const_1141);
         var_655.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_542.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_542.splice(_loc3_,1);
            var_541.splice(_loc3_,1);
         }
         var_541.push(param1.name);
         var_542.push(param2);
         param1.addEventListener(WindowEvent.const_453,windowEventListener);
         param1.addEventListener(WindowEvent.const_221,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_542[var_541.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1132.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_323.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_323.splice(var_323.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1132.getIconLoc(param1.iconId);
      ...
      {
         return var_541[var_542.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_323[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_656[_loc3_] = new Array();
            }
            if(var_656[_loc3_].indexOf(param1) < 0)
            {
               var_656[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_801 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_801 || param1.desktop.height - param1.y < const_1143;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_541[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_656[_loc3_].length)
                  {
                     repositionWindow(var_656[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
