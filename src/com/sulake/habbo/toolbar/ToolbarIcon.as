package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         _events = param5;
         var_269 = param6;
         var_1247 = new Timer(40,40);
         var_1247.addEventListener(TimerEvent.TIMER,updateBouncer);
         var_103 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_384,HabboWindowStyle.const_34,HabboWindowParam.const_37,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1516[var_1049.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_269)
               {
                  var_269.repositionWindow(var_719,true);
               }
               if(_events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_53);
      ...
      {
         return var_602.indexOf(param1) > -1;
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_859[var_602.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_103.toolTipCaption = "${toolbar.icon.tooltip." + var_1795.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_269 != null)
         {
            var_269.animateWindowIn(this,param1,param2,var_719,param3,param4,getMenuYieldList(param1));
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_1781 = int(param1.@window_margin);
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.hideWindow(param1,param2,var_719,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.positionWindow(this,param1,param2,var_719,param3,getMenuYieldList(param1));
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         var _loc1_:StateItem = getCurrentStateObject();
         if(_loc1_ != null && var_1048)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            var_406 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_87,_y,_bitmapData);
            if(false)
            {
               var_718 = new Timer(_loc1_.timer);
               var_718.addEventListener(TimerEvent.TIMER,updateAnimator);
               var_718.start();
            }
            if(_loc1_.bounce)
            {
      ...
      {
         return var_1781 + var_494.windowMargin;
      }
