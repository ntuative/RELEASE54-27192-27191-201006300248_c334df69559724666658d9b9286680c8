package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1620:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_269:ToolbarBarMenuAnimator;
      
      private var var_1619:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_215 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_51,HabboWindowStyle.const_1035,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1377 = _loc7_.toolbar.@margin_bottom;
         var_1620 = _loc7_.toolbar.@min_group_margin;
         var_1619 = _loc7_.toolbar.@margin_to_extrabar;
         var_269 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_283,param1,param2,_window,var_269);
         createGroupsFromXmlList(_loc9_,var_652,param1,param2,var_215,var_269);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_283.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_652.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_144,var_540,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1620,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1377) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1620,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1377) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_144,var_540);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_283.length)
         {
            _loc2_ = var_283[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_652.length)
         {
            _loc2_ = var_652[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_144,var_540);
         }
      }
