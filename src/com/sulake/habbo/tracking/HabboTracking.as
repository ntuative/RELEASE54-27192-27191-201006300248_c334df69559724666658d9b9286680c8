package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_828:uint = 11;
      
      private static var _instance:HabboTracking;
       
      
      private var var_256:LatencyTracker = null;
      
      private var var_257:PerformanceTracker = null;
      
      private var var_582:FramerateTracker = null;
      ...
      private var var_168:IHabboHelp;
      
      private var var_1192:int = -1;
      
      private var var_1012:LagWarningLogger = null;
      
      private var var_1013:IHabboWindowManager;
      ...
      private var var_192:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_257 = new PerformanceTracker();
         var_582 = new FramerateTracker();
         var_256 = new LatencyTracker();
         var_1012 = new LagWarningLogger();
         var_1473 = new Array(const_828);
         var _loc4_:int = 0;
         while(_loc4_ < const_828)
         {
            var_1473[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1216,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1253,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_651,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_988,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_710:
               trackLoginStep(HabboLoginTrackingStep.const_1229,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_207:
               trackLoginStep(HabboLoginTrackingStep.const_207);
               break;
            case HabboCommunicationEvent.const_172:
            ...
            case HabboCommunicationEvent.const_160:
               ...
               break;
            case HabboCommunicationEvent.const_194:
               setErrorContextFlag(3,0);
               trackLoginStep(HabboLoginTrackingStep.const_194);
               if(var_256 != null)
               {
                  var_256.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_256 != null)
            {
               var_256.communication = _communication;
               var_256.connection = param1;
            }
            if(var_1012 != null)
            {
               var_1012.connection = param1;
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_150)
         {
            Component(var_150).events.addEventListener(HabboConfigurationEvent.const_178,onConfigurationLoaded);
            if(var_256 != null)
            {
               var_256.configuration = var_150;
            }
            if(var_257 != null)
            {
               var_257.configuration = var_150;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_274.events.addEventListener(AdEvent.const_500,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2389)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1240);
            var_2389 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_988,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_651,String(true));
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_348:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_1013)
            {
               var_1013.release(new IIDHabboWindowManager());
               var_1013 = null;
            }
            if(var_274)
            {
            ...
            if(var_192)
            {
               if(true)
               {
                  Component(var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_192).events.removeEventListener(HabboFriendListTrackingEvent.const_348,onFriendlistTrackingEvent);
               }
               var_192.release(new IIDHabboFriendList());
               var_192 = null;
            }
            if(var_168)
            {
               if(true)
               {
                  var_168.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_168.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_168.release(new IIDHabboHelp());
               var_168 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_446,onLagWarningEvent);
               }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_710,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_172,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_194,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_376,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_446:
               var_1012.warpingDetected();
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_150)
         {
            if(var_1012 != null)
            {
               var_1012.configure(var_150);
            }
            if(var_582 != null)
            {
               var_582.configure(var_150);
            }
            Component(var_150).events.removeEventListener(HabboConfigurationEvent.const_178,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_98);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_98,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_168 = param2 as IHabboHelp;
         var_168.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_168.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_865);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_865,onCoreRunning);
         }
      }
      ...
      {
         var_1013 = IHabboWindowManager(param2);
         if(var_1013)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1192 > -1 && _loc2_ < var_1192)
         {
            ++var_1713;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1713);
         }
         if(var_1192 > -1 && _loc2_ - var_1192 > 15000)
         {
            ++var_1714;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1714);
         }
         var_1192 = _loc2_;
         if(var_257 != null)
         {
         ...
         if(var_582 != null)
         {
            var_582.trackUpdate(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_150 != null && !Boolean(var_150.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_446,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_266,onRoomAdClick);
      }
      ...
      {
         var_192 = param2 as IHabboFriendList;
         Component(var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_192).events.addEventListener(HabboFriendListTrackingEvent.const_348,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_150)
            {
               if(var_150.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_257 != null)
                  {
                     _loc4_["null"] = var_257.flashVersion;
                     _loc4_["null"] = var_257.averageUpdateInterval;
                  }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_98,onLocalizationLoaded);
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1221);
         }
         else if(param1.type == HabboHotelViewEvent.const_376)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1308);
         }
