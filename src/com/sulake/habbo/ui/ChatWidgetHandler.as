package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_932:Number = 0.0;
      
      private var var_531:Point = null;
      
      private var _isDisposed:Boolean = false;
      
      private var var_372:Map = null;
      
      private var var_770:Map = null;
      
      private var var_530:Vector3d;
      ...
      public function dispose() : void
      {
         ...
         if(var_373 != null)
         {
            ...
            {
               _loc2_ = var_373.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_372.length)
            {
               _loc2_ = var_372.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_211)
                           {
                              _loc13_ = var_372.getValue(_loc15_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = var_373.getValue(_loc15_) as BitmapData;
                           }
                           _loc12_ = uint(var_770.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_39);
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_211)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       var_372.add(_loc15_,_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    var_373.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_770.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_533,RoomWidgetChatSelectAvatarMessage.const_617];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_533:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_150,_container.roomSession,0,"Version 27192-27191-201006300239");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_617:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_932 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_932);
            }
            if(var_531 == null)
            {
               var_530.x = 0;
               var_530.y = 0;
               var_530.z = 0;
               var_531 = _loc4_.getScreenPoint(var_530);
               var_932 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_530.x = 0;
            var_530.y = 0;
            var_530.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_530);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_531.x || _loc8_.y != var_531.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_531,_loc5_));
