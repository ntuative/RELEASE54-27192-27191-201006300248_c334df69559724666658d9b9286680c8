package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_103:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_640,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_137:
               _loc2_ = param1 as RoomSessionDoorbellEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_137,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_530];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_530:
      ...
      {
         return [RoomSessionDoorbellEvent.const_103,RoomSessionDoorbellEvent.const_137,RoomSessionDoorbellEvent.const_52];
      }
