package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_687,RoomWidgetEcotronBoxOpenMessage.const_570,RoomWidgetEcotronBoxOpenedMessage.const_1274];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_687:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_570:
