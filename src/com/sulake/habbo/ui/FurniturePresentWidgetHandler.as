package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1084:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_741,RoomWidgetPresentOpenMessage.const_643,RoomWidgetPresentOpenedMessage.const_1432];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_77:
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_84)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_399,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_190)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_419,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1084)
                              {
                                 break;
                              }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_741:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_165 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_100);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_643:
               _loc4_ = param1 as RoomWidgetPresentOpenMessage;
               if(_loc4_.objectId != var_165)
               {
                  return null;
               }
