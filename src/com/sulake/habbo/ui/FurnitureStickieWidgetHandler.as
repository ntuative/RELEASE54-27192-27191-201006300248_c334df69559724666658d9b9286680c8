package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_375;
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_724,RoomWidgetStickieSendUpdateMessage.const_731,RoomWidgetStickieSendUpdateMessage.const_469];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_724:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_906);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_469:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_731:
