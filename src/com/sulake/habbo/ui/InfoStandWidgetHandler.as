   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_152,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_153,onPetInfo);
         ...
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_152,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_153,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_693);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_319);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1053);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_989);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_211)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1022)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_472);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_238)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_222)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_765);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1231;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_948;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_845;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1215);
               }
               else
               {
               ...
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_29,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_29,true);
                  _loc19_.dispose();
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_29,4);
               _loc4_ = _loc5_.getImage(AvatarSetType.const_29,true);
               _loc5_.dispose();
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_647.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_49);
            var_647.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_29),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_765);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_324);
         _loc1_.push(RoomWidgetUserActionMessage.const_740);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_295);
         _loc1_.push(RoomWidgetFurniActionMessage.const_656);
         _loc1_.push(RoomWidgetFurniActionMessage.const_610);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_678);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_739);
         _loc1_.push(RoomWidgetUserActionMessage.const_490);
         _loc1_.push(RoomWidgetUserActionMessage.const_752);
         _loc1_.push(RoomWidgetUserActionMessage.const_673);
         _loc1_.push(RoomWidgetUserActionMessage.const_1192);
         _loc1_.push(RoomWidgetPetCommandMessage.const_620);
         _loc1_.push(RoomWidgetPetCommandMessage.const_593);
      ...
      private function onPetCommands(param1:RoomSessionPetCommandsUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            _loc2_ = new RoomWidgetPetCommandsUpdateEvent(param1.petId,param1.method_6);
      ...
      public function dispose() : void
      {
         ...
         if(var_647 != null)
         {
            _loc1_ = var_647.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_647.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_490)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_324:
               return handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_740:
            ...
            case RoomWidgetUserActionMessage.const_527:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_951,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_441:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_678:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_739:
               ...
               break;
            case RoomWidgetUserActionMessage.const_490:
