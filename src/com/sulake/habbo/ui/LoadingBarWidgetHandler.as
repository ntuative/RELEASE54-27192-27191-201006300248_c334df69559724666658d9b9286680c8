package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_414:
               _loc2_ = param1 as AdEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               _loc3_ = new RoomWidgetInterstitialUpdateEvent(RoomWidgetInterstitialUpdateEvent.const_91,_loc2_.image,_loc2_.clickUrl);
               _container.events.dispatchEvent(_loc3_);
               break;
            case AdEvent.const_450:
               _container.setInterstitialCompleted();
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_91:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_414);
         _loc1_.push(AdEvent.const_450);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_91);
