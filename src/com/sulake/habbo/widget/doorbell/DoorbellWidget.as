package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1087:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_640,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_137,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_640,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_137,onDoorbellHandled);
