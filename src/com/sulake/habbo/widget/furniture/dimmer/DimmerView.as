package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1070:Number = 100;
       
      
      private var var_1414:XML;
      
      private var var_448:int;
      
      private var var_565:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2214:int;
      
      private var var_385:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_254.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_254.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_51,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1071,const_1070,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_565 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_385 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_254 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_254.numTabItems)
         {
            _loc6_ = var_254.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_565 != null)
         {
            var_565.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_254.selector.getSelected();
         return var_254.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_385 != null)
         {
            var_385.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1159 = _loc2_.light;
         if(var_385 != null)
         {
            var_385.setValue(var_1159);
         }
         var_448 = colors.indexOf(_loc2_.color);
         if(var_565 != null)
         {
            var_565.setSelectedColorIndex(var_448);
         }
