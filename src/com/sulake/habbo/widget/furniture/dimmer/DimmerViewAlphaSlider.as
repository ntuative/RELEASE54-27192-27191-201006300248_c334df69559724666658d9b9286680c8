package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_92 && param1.type != WindowMouseEvent.const_508)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1569 * (var_1078 - var_740)) + var_740;
      }
   }
}
