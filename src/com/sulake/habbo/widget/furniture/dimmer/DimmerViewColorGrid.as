package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_1338:XML;
      
      private var var_316:IWindowContainer;
      
      private var var_431:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_431.destroyGridItems();
         var_316 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1338) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_921.width,var_921.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_763.width,var_763.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_763,var_763.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_431.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_431.numGridItems)
         {
            return;
         }
         select(var_431.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_921 = BitmapData(_loc3_.content);
