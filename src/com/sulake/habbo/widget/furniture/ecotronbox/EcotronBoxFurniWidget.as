package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_570,var_165);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_51,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1071,const_1070,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_220 != null)
         {
            _loc6_.caption = var_220;
         }
