package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1746:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1748:String = "level";
      
      private var var_111:IItemListWindow;
      
      private const const_1744:String = "energy";
      
      private var var_1358:Map;
      
      private const const_1747:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1745:uint = 3355443;
      
      private var var_251:IBorderWindow;
      
      private const const_1749:int = 158;
      
      private const const_1751:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_181:PetCommandTool;
      
      private const const_1750:uint = 11184810;
      
      private const const_1743:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_251.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_251.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_111.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_111.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_181 == null)
         {
            var_181 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1358.getValue(var_636) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_181.showWindow(true);
            var_181.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_111.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_111.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1748,param1.level,param1.levelMax);
         updateStateElement(const_1743,param1.experience,param1.experienceMax);
         updateStateElement(const_1744,param1.energy,param1.energyMax);
         updateStateElement(const_1747,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_636 = param1.id;
         var_1358.remove(param1.id);
         var_1358.add(param1.id,param1);
         if(var_181 && var_181.isVisible() && param1.isOwnPet)
         {
            var_181.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_111.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_181.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_181 && var_181.getPetId() == var_636)
               {
                  var_181.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_487,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1749,const_1751,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1750);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1745);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1746);
         return _loc5_;
      }
