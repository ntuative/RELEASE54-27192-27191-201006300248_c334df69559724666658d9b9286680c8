package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_993:TagListRenderer;
      
      protected var var_65:IItemListWindow;
      
      private var var_251:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_993 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_251 = _window.getListItemByName("info_border") as IBorderWindow;
         ...
         if(var_251 != null)
         {
            var_111 = var_251.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_251.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_251.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_251.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_251.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_121.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_121.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_121.x = _loc5_.left - 0;
         var_121.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_111.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_111.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_111.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_111 == null || var_251 == null || var_65 == null)
         {
            return;
         }
         ...
         var_251.height = NaN;
         _window.width = Math.max(var_251.width,var_65.width);
      ...
      {
         var _loc2_:ITextWindow = var_111.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_111.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_111.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_111.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_993.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_111.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_111.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_121 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_121 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_948:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_845:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_121.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_121.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_121.x = _loc7_.left - 0;
         var_121.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_111.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_111.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_238:
               var_65.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_222:
      ...
      {
         var _loc3_:IWindowContainer = var_111.getListItemByName("image_and_badges_container") as IWindowContainer;
