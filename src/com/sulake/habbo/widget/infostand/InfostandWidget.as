package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1463:String = "infostand_user_view";
      
      private var var_311:InfoStandPetView;
      
      private var var_1358:InfoStandPetData;
      
      private var var_132:Timer;
      
      private var var_862:InfoStandFurniView;
      ...
      private const const_1465:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1464:String = "infostand_pet_view";
      
      private const const_1466:String = "infostand_furni_view";
      
      private const const_1731:int = 3000;
      
      private var var_200:InfoStandUserView;
      
      private var var_429:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_862 = new InfoStandFurniView(this,const_1466);
         var_200 = new InfoStandUserView(this,const_1463);
         var_311 = new InfoStandPetView(this,const_1464);
         var_351 = new InfoStandBotView(this,const_1465);
         var_429 = new InfostandUserData();
         var_424 = new InfostandFurniData();
         var_1358 = new InfoStandPetData();
         var_132 = new Timer(const_1731);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         if(param1.isOwnUser)
         {
            var_200.setTags(param1.tags);
         }
         else
         {
            var_200.setTags(param1.tags,var_1820);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_242,onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_259,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_117,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_152,onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_135,onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_596,onBadgeImage);
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         var_311.update(petData);
         selectView(const_1464);
         if(var_132)
         {
            var_132.start();
         }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_441,var_311.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_242,onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_259,onRoomObjectRemoved);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_117,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_152,onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_135,onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_596,onBadgeImage);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               var_200.setBadgeImage(_loc2_,param1.badgeImage);
            }
            return;
         }
         if(param1.badgeID == userData.groupBadgeId)
         {
            var_200.setGroupBadgeImage(param1.badgeImage);
         }
      }
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_51,HabboWindowStyle.const_34,HabboWindowParam.const_34,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_259:
               if(var_200 != null && false && var_200.window.visible)
               {
                  _loc2_ = param1.id == var_429.userRoomId;
                  break;
               }
               if(var_311 != null && false && var_311.window.visible)
               {
                  _loc2_ = param1.id == var_1358.roomIndex;
                  break;
               }
      ...
      {
         var_311.updateEnabledTrainingCommands(param1.id,param1.method_6);
      }
