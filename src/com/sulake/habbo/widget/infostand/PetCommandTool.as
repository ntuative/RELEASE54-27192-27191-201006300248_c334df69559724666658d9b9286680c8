package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_368:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_1100:Map;
      
      private const const_1736:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_1100 = new Map();
         var_369 = new Timer(const_1736);
         var_369.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      private function createCommandWindow() : void
      {
         ...
         var_43.setParamFlag(WindowParam.const_87,true);
         var_43.context.getDesktopWindow().addEventListener(WindowEvent.const_42,onWindowDesktopResized);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_593,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_368 == null)
         {
            ...
            var_368 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_368 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_368.x = 200;
            var_368.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      {
         var _loc2_:Array = var_1100.getValue(var_636) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_441,var_636));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_620,var_636,var_2013 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1100.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_636);
         }
         else
         {
