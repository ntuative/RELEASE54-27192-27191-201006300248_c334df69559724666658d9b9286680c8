package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_944:IWindow;
      
      private var var_943:IWindow;
      ...
      {
         super();
         var_186 = new Timer(1000);
         var_186.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_944 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_184.duration);
               var_944.width = _loc2_ * var_454;
            }
            else
            {
               var_944.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_943 = _window.findChildByName("effect_hilite");
            var_943.visible = false;
         }
         var_942 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_944 = _window.findChildByName("loader_bar");
         if(var_944 != null)
         {
            var_454 = var_944.width;
            var_186.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_184.icon);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_186.stop();
            var_186.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_186 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_942 != null)
         {
            var_942.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_942.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
