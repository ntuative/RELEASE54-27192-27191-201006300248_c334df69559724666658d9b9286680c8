package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.addEventListener(WindowEvent.const_256,onChildResized);
         _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_346,_window));
      }
      ...
      public function dispose() : void
      {
         if(_widget && false)
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_720));
         }
         _widget = null;
         if(false)
         {
