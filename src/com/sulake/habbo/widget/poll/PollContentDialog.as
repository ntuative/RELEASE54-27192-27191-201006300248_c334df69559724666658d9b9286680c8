package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_771[var_1122] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_321)
         {
            ...
            var_321 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_321.center();
            var_321.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function method_8() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1122;
         if(var_1122 < var_771.length)
         {
            _loc1_ = var_771[var_1122] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_771.length);
                  _loc2_.text = _loc6_;
               }
