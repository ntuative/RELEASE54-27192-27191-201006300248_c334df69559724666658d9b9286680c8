package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         _isDisposed = false;
         _widget = param1;
         var_163 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         var_163.state = RoomChatHistoryPulldown.const_217;
         ...
         var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_941,HabboWindowStyle.const_34,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_239 > 0 && param2)
         {
            if(var_1381)
            {
               if(Math.abs(param1 - var_239) <= const_932)
               {
                  return;
               }
               var_1381 = false;
            ...
            if(var_324)
            {
               ...
               _loc3_ = var_378 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_239;
               _loc7_ = true;
               _loc8_ = true;
               if(var_46.scrollV < 1 - const_1145 / var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1623)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_324 && !var_1317)
         {
            ...
            var_163.state = RoomChatHistoryPulldown.const_332;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_163.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_217);
      }
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(var_46 != null)
         {
            ...
            if(param2)
            {
               var_46.scrollV = var_378;
            }
         }
         if(var_163 != null)
         {
            var_163.containerResized(param1);
         }
      }
