package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_516:int = 6;
      
      private static const const_366:int = 10;
      
      private static const const_1131:Number = 18;
      
      private static const const_1475:Number = 10;
      
      private static const const_1474:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1114,var_1113,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1114,var_766,var_1113,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1349 = param1.chatType;
         var_1114 = param1.userId;
         var_766 = param1.userName;
         var_1113 = param1.userCategory;
         _message = param1.text;
         var_1347 = param1.userX;
         var_208 = param1.userImage;
         var_1112 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_92,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1349)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_255:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_292:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_208 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_208.height);
         }
         ...
         if(var_208 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_208.width;
               _loc28_.height = var_208.height;
               _loc28_.bitmap = new BitmapData(var_208.width,var_208.height,true,0);
               _loc28_.bitmap.copyPixels(var_208,var_208.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_436 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_208.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1112 != 0)
            {
               _loc30_ = uint(var_1112 >> 16 & 255);
               _loc31_ = uint(var_1112 >> 8 & 255);
               _loc32_ = uint(var_1112 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1349 == RoomWidgetChatUpdateEvent.const_255)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_766);
            }
            else if(var_1349 == RoomWidgetChatUpdateEvent.const_292)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_766);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_436;
            _loc20_.width = _loc20_.textWidth + const_516;
            _width += _loc20_.textWidth + const_516;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_366 + _loc20_.textWidth + const_516;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1114,var_1113,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1114,var_1113,_roomId,_roomCategory,param1);
      }
