   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_191 != null)
         {
            while(false)
            {
               _loc1_ = var_191[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_191.length > param1)
         {
            _loc2_ = var_191["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < var_191.length)
         {
            return var_191[param1];
         }
         return null;
      }
