package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1483:int = 50;
      ...
      private var var_242:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1634:Boolean = false;
      
      private var var_2144:Number = -1.0E7;
      
      private var var_2141:Number = -1.0E7;
      
      private var var_2512:int = 0;
      
      private var var_550:RoomObjectCache;
      
      private var var_785:int;
      
      private var var_290:Sprite;
      
      private var var_1144:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_242 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_330 = new Map();
         var_550 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_242.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_242.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_550.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_953 == 0)
         {
            checkMouseHits(var_1145.x,var_1145.y,MouseEvent.MOUSE_MOVE);
         }
         var_953 = 0;
         ++var_789;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_290 != null)
         {
            var_290.graphics.clear();
         }
         else
         {
            var_290 = new Sprite();
            var_290.name = "mask";
            _master.addChild(var_290);
         }
         var_290.graphics.beginFill(0);
         var_290.graphics.drawRect(0,0,param1,param2);
         var_785 = param1;
         var_786 = param2;
         var_57.graphics.clear();
         var_57.graphics.beginFill(var_2512);
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - var_786 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_785 != var_2140 || var_786 != var_2143)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_450.sortOn("z",0 | 0);
         if(_loc5_ < var_450.length)
         {
            var_450.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_450[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_551.length)
            {
               cleanSprite(var_551[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_551 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_330 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_330.getKey(_loc1_);
            _loc3_ = var_330.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1144 != null)
                  {
                     var_1144.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_789,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_242.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_242.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1145.x = param1;
         var_1145.y = param2;
         if(var_953 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1634;
         }
         var_1634 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_953;
         return var_1634;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_450.length)
         {
            return null;
         }
         return var_450[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_330 != null && param1 != null)
         {
            var_330.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_552.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_552.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2144 || param2 != var_2141)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_552.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_552.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_551.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_242.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_242.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_550.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_550.getObjectCache(param2);
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_785 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_786))
                  {
