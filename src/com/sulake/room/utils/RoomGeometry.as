package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_698:Number = 64;
      ...
      private var var_1627:Number = 1.0;
      ...
      private var var_1628:Number = 1.0;
      
      private var var_2508:Number = 500.0;
      
      private var var_1629:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_88 = new Vector3d();
         var_1136 = new Vector3d();
         var_1627 = 1;
         var_1629 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1628 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_240.assign(param1);
         if(var_240.x != _loc2_ || var_240.y != _loc3_ || var_240.z != _loc4_)
         {
            ++var_80;
         }
      ...
      {
         if(var_446 != param1 * var_1628)
         {
            var_446 = param1 * var_1628;
            ++var_80;
         }
      }
      ...
      {
         if(var_447 != param1 * var_1627)
         {
            var_447 = param1 * var_1627;
            ++var_80;
         }
      }
      ...
      {
         if(var_444 != param1 * var_1629)
         {
            var_444 = param1 * var_1629;
            ++var_80;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_445 != null)
         {
            ...
            var_445.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_445.add(_loc3_,_loc4_);
            ++var_80;
         }
      }
      ...
      {
         return new Vector3d(var_240.x,var_240.y,var_240.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1136.assign(_loc22_);
         }
         else
         {
            var_1136.assign(_loc17_);
         }
         ++var_80;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_444;
         _loc2_.z *= var_446;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1136);
         if(_loc3_ < var_2509 || _loc3_ > var_2508)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_444;
            _loc2_.z *= var_446;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1136);
         }
      ...
      {
         return new Vector3d(0 * var_447,0 * var_444,0 * var_446);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_445 != null)
         {
            ...
            return var_445.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_447,0 * var_444,0 * var_446);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_88;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_447,param2.y * var_444,param2.z * var_446);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_447,param3.y * var_444,param3.z * var_446);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_447,param4.y * var_444,param4.z * var_446);
